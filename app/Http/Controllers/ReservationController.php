...
// VIEW ADD ACCOMMODATION ==================================================================================================================================================================================
    ...
    // ADD GUESTS ==================================================================================================================================================================================
    public function func_add_guest(Request $request)
    {
    ...
    public function func_update_guest(Request $request, $id)
    {
        ...
        // @dd($guest);
        return redirect()->back()->with('success','Guest has been updated to the reservation');
    ...
    {
        $reservation=Reservation::findOrFail($id);
        $order = Orders::where('rsv_id',$id)->get();
        
        if ($request->pickup_name) {
            $guest=Guests::where('rsv_id',$id)
