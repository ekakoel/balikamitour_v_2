                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="card-box">
                                ...
                                <form id="update-transport" action="/fupdate-transport/{{ $transport->id }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                    <div class="row">
                                ...
                                <div class="card-box-footer">
                                    <button type="submit" form="update-transport" class="btn btn-primary"><i class="icon-copy fa fa-check" aria-hidden="true"></i> Save</button>
