                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input readonly type="text" name="period_start" class="form-control date-picker @error('period_start') is-invalid @enderror" placeholder="Select date" value="{{ dateFormat($weddingVenue->periode_start) }}" required>
                                                @error('period_start')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-12 col-sm-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input readonly type="text" name="period_end" class="form-control date-picker @error('period_end') is-invalid @enderror" placeholder="Select date" value="{{ dateFormat($weddingVenue->periode_end) }}" required>
                                                @error('period_end')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
