                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="description" class="ckeditor form-control @error('description') is-invalid @enderror" placeholder="Insert description" value="{{ $dinner_venue->description }}">{!! $dinner_venue->description !!}</textarea>
                                                    @error('description')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-12 col-sm-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="terms_and_conditions" class="ckeditor form-control @error('terms_and_conditions') is-invalid @enderror" placeholder="Insert terms_and_conditions" value="{{ $dinner_venue->terms_and_conditions }}">{!! $dinner_venue->terms_and_conditions !!}</textarea>
