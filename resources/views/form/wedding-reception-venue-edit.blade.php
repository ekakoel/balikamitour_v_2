                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-6 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="status" class="form-control custom-select col-12 @error('status') is-invalid @enderror" required>
                                            ...
                                            <div class="col-12 col-sm-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="description" class="tiny_mce form-control @error('description') is-invalid @enderror" placeholder="Insert description" value="{{ $reception_venue->description }}">{!! $reception_venue->description !!}</textarea>
                                                    @error('description')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-12 col-sm-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="terms_and_conditions" class="tiny_mce form-control @error('terms_and_conditions') is-invalid @enderror" placeholder="Insert terms_and_conditions" value="{{ $reception_venue->terms_and_conditions }}">{!! $reception_venue->terms_and_conditions !!}</textarea>
