            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="title">
                            <i class="icon-copy fi-torso-business"></i><i class="icon-copy fi-torso-female"></i>
                            {{ $wedding->name }}
                        </div>
                        <nav aria-label="breadcrumb" role="navigation">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="/wedding-{{ $wedding->code }}">{{ $wedding->name }}</a></li>
                                <li class="breadcrumb-item active">@lang('messages.Order')</li>
                            ...
                            <div class="row">
                                ...
                                @if ($wedding->include)
                                    <div class="col-12 m-b-8">
                                        ...
                                        {{-- WEDDING VENUE --}}
                                        @include('order.order_wedding_fixed_service')
                                    </div>
                                @endif
                                ...
                                <div class="col-md-12 m-b-18">
                                    <div class="tab-inner-title m-t-8">@lang('messages.Optional Services')</div>
                                    <div class="data-web-text-area">
                                        @lang('messages.Choose and mark one or more optional services by checking the boxes provided for each service to be added to the wedding package you have ordered. Unchecked optional services will not be added to your order.')
                                    </div>
                                    {{-- WEDDING VENUE --}}
                                    ...
                                    <div class="card-box-content">
                                        @include('order.order_wedding_venues')
                                    </div>
                                    ...
                                    <div class="card-box-content">
                                        @include('order.order_wedding_room')
                                    </div>
                                    {{-- WEDDING DECORATION --}}
                                    <div class="subtitle-card">
                                        @lang('messages.Decorations')
                                    </div>
                                    <div class="card-box-content">
                                        @include('order.order_wedding_decoration')
                                    </div>
                                    ...
                                    <div class="card-box-content">
                                        @include('order.order_wedding_dinner_venue')
                                    </div>
                                    {{-- WEDDING MAKEUP --}}
                                    <div class="subtitle-card">
                                    ...
                                    <div class="card-box-content">
                                        @include('order.order_wedding_makeup')
                                    </div>
                                    ...
                                    <div class="card-box-content">
                                        @include('order.order_wedding_entertainment')
                                    </div>
                                    {{-- WEDDING DOCUMENTATION --}}
                                    <div class="subtitle-card">
                                        @lang('messages.Documentations')
                                    </div>
                                    <div class="card-box-content">
                                        @include('order.order_wedding_documentation')
                                    </div>
                                    {{-- WEDDING TRANSPORT --}}
                                    <div class="subtitle-card">
                                        @lang('messages.Transports')
                                    </div>
                                    <div class="card-box-content">
                                        @include('order.order_wedding_transport')
                                    </div>
                                    {{-- WEDDING OTHER --}}
                                    <div class="subtitle-card">
                                    ...
                                    <div class="card-box-content">
                                        @include('order.order_wedding_other')
                                    </div>
                                </div>
                                <div class="col-md-12">
