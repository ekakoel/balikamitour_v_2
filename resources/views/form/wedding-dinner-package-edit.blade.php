                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="include" class="tiny_mce form-control @error('include') is-invalid @enderror" placeholder="Insert include" value="{{ $dinnerPackage->include }}">{{ $dinnerPackage->include }}</textarea>
                                                @error('include')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="additional_info" class="tiny_mce form-control @error('additional_info') is-invalid @enderror" placeholder="Insert additional_info" value="{{ $dinnerPackage->additional_info }}">{{ $dinnerPackage->additional_info }}</textarea>
