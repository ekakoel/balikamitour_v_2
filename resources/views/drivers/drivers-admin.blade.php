                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="card-box">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="table-action">
                                                            <a href="modal" data-toggle="modal" data-target="#driver-view-{{ $driver->id }}">
                                                                <button class="btn-view"><i class="dw dw-eye"></i></button>
                                                            </a>
                                                            @canany(['posDev','posAuthor'])
                                                                <a href="modal" data-toggle="modal" data-target="#driver-edit-{{ $driver->id }}">
                            ...
                            @canany(['posDev','posAuthor'])
                                <div class="card-box-footer">
                                    <a href="modal" data-toggle="modal" data-target="#driver-add">
