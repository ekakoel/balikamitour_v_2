...
@endphp
    <div class="tab-inner-title">
        ...
        @if ($weddings->status !== "Active")
            <span>
                <a href="modal" data-toggle="modal" data-target="#add-wedding-transports-active">
            ...
            <div class="card-box-content m-b-8">
                @foreach ($transport_id as $transportid)
                    ...
                    @if ($transport_price > 0)
                        ...
                        <div class="card">
                            <a href="modal" data-toggle="modal" data-target="#detail-transports_active-{{ $transportid }}">
