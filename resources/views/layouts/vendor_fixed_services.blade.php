...
@if (count($fixed_services)>0)
    ...
    <div class="card-box-content">
        @foreach ($fixed_services as $fixno=>$fixed_service)
            ...
            @endphp
            <div class="card">
                <a href="modal" data-toggle="modal" data-target="#detail-package-{{ $fixed_service->id }}">
                ...
                <div class="price-card m-t-8">
                    {{"$ " . number_format($fixed_service->publish_rate, 0, ",", ".") }}
                </div>
                @canany(['posDev','weddingDvl','weddingAuthor'])
                    <div class="card-delete-btn">
                        <a href="modal" data-toggle="modal" data-target="#edit-package-{{ $fixed_service->id }}">
                                    ...
                                    <div class="card-text">
                                        ...
                                        <div class="row ">
                                            <div class="col-6 col-sm-4 m-b-8">
                                                ...
                                                <div class="idr-rate">{{ "Rp ".number_format($fixed_service->contract_rate, 0, ",", ".") }}</div>
                                            ...
                                            <div class="col-6 col-sm-4 m-b-8">
                                                ...
                                                <div class="rate-usd">{{ "$ ".number_format($fixed_service->markup, 0, ",", ".") }}</div>
                                            </div>
                                            <div class="col-6 col-sm-4 m-b-8">
                                            ...
                                            <div class="col-6 col-sm-4 m-b-8">
                                                ...
                                                <div class="usd-rate">{{ "$ ".number_format($fixed_service->publish_rate, 0, ",", ".") }}</div>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6 col-md-6">
                                            <div class="form-group ">
                                                ...
                                                <select id="fixedType" name="type" type="text" class="form-control @error('type') is-invalid @enderror" placeholder="Select type" required>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" id="update-description-package{{ ++$fixno }}" wire:model="description" class="ckeditor form-control @error('description') is-invalid @enderror" placeholder="Description" type="text">{!! $fixed_service->description !!}</textarea>
                                                @error('description')
                                                    <span class="invalid-feedback">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
