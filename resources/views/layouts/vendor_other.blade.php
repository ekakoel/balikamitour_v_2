...
@if (count($package_others)>0)
    ...
    <div class="card-box-content">
        @foreach ($package_others as $no=>$package_other)
            ...
            @endphp
            <div class="card">
                <a href="modal" data-toggle="modal" data-target="#detail-package-{{ $package_other->id }}">
                ...
                @canany(['posDev','weddingDvl','weddingAuthor'])
                    <div class="card-delete-btn">
                        <a href="modal" data-toggle="modal" data-target="#edit-package-{{ $package_other->id }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6 col-md-6">
                                            <div class="form-group ">
                                                ...
                                                <select id="otherType" name="type" type="text" class="form-control @error('type') is-invalid @enderror" placeholder="Select type" required>
