...
@if (count($ceremony_venue_decoration)>0)
    ...
    <div class="card-box-content">
        @foreach ($ceremony_venue_decoration as $cerno=>$ceremony_decoration)
            ...
            @endphp
            <div class="card">
                <a href="modal" data-toggle="modal" data-target="#detail-package-{{ $ceremony_decoration->id }}">
                ...
                @canany(['posDev','weddingDvl','weddingAuthor'])
                    <div class="card-delete-btn">
                        <a href="modal" data-toggle="modal" data-target="#edit-package-{{ $ceremony_decoration->id }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6 col-md-6">
                                            <div class="form-group ">
                                                ...
                                                <select id="ceremonyType" name="type" type="text" class="form-control @error('type') is-invalid @enderror" placeholder="Select type" required>
...
@if (count($reception_venue_decoration)>0)
    ...
    <div class="card-box-content m-b-18">
        @foreach ($reception_venue_decoration as $recno=>$reception_decoration)
            ...
            @endphp
            <div class="card">
                <a href="modal" data-toggle="modal" data-target="#detail-package-{{ $reception_decoration->id }}">
                    <div class="image-container">
                ...
                @canany(['posDev','weddingDvl','weddingAuthor'])
                    <div class="card-delete-btn">
                        <a href="modal" data-toggle="modal" data-target="#edit-reception-decoration-{{ $reception_decoration->id }}">
                            <button class="btn-edit" data-toggle="tooltip" data-placement="top" title="Update"><i class="icon-copy fa fa-pencil"></i></button>
                        </a>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6 col-md-6">
                                            <div class="form-group ">
                                                <label for="type">Type <span>*</span></label>
                                                <select id="receptionType" name="type" type="text" class="form-control @error('type') is-invalid @enderror" placeholder="Select type" required>
