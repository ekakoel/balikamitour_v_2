    ...
    <div class="card-box">
        ...
        <div class="input-container">
            <div class="input-group">
                ...
                <input id="searchOrderNo" type="text" onkeyup="searchTable('searchOrderNo','tblptp',1)" class="form-control" name="search-active-order-byagn" placeholder="Order number">
            </div>
            <div class="input-group">
                <span class="input-group-addon"><i class="icon-copy fa fa-search" aria-hidden="true"></i></span>
                <input id="searchByGuestName" type="text" onkeyup="searchTable('searchByGuestName','tbltp',2)" class="form-control" name="search-active-order-type" placeholder="Guest name">
            </div>
        </div>
                        ...
                        <td class="text-right">
                            ...
                            <div class="table-action">
                                @if ($tourorder->status == "Draft")
                                    <a href="/edit-order-{{ $tourorder->id }}">
                                ...
                                @elseif ($tourorder->status == "Rejected")
                                    <a href="/detail-order-{{ $tourorder->id }}">
