    ...
    <div class="card-box m-b-18">
        ...
        <div class="input-container">
            <div class="input-group">
                ...
                <input id="searchActivityOrderNo" type="text" onkeyup="searchTable('searchActivityOrderNo','tbActivityOrder',1)" class="form-control" name="search-active-order-byagn" placeholder="Order number">
            </div>
            <div class="input-group">
                <span class="input-group-addon"><i class="icon-copy fa fa-search" aria-hidden="true"></i></span>
                <input id="searchActivityByGuestName" type="text" onkeyup="searchTable('searchActivityByGuestName','tbActivityOrder',2)" class="form-control" name="search-active-order-type" placeholder="Guest name">
            </div>
        </div>
                        ...
                        <td class="text-right">
                            ...
                            <div class="table-action">
                                @if ($activityorder->status == "Draft")
                                    <a href="/edit-order-{{ $activityorder->id }}">
