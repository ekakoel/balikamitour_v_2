    ...
    <div id="accommodations" class="col-md-12">
                    ...
                    <tr>
                        ...
                        <td class="pd-2-8 text-right">
                            <div class="table-action">
                                <a href="modal" data-toggle="modal" data-target="#update-wedding-planner-bride-accommodation-{{ $bride_wedding_accommodation->id }}">
                    ...
                    @foreach ($invitations_wedding_accommodation as $inv_suite_villa)
                        ...
                        @endphp
                            <tr>
                                ...
                                <td class="pd-2-8 text-right">
                                    <div class="table-action">
                                        <a href="modal" data-toggle="modal" data-target="#update-wedding-planner-invitations-accommodation-{{ $inv_suite_villa->id }}">
                                            <button class="btn-edit" data-toggle="tooltip" data-placement="top" title="@lang('messages.Edit Accommodation')"><i class="icon-copy fa fa-pencil"></i></button>
                                        </a>
        ...
        <div class="row">
            <div class="col-md-12 text-right">
                <a href="modal" data-toggle="modal" data-target="#add-wedding-planner-accommodation-{{ $wedding_planner->id }}">
