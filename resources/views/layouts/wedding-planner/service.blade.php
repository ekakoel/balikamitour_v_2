        ...
        <div class="row">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td class="pd-2-8 text-right">
                                    <div class="table-action">
                                        <a href="modal" data-toggle="modal" data-target="#detail-ceremonial-venue-{{ $ceremony_venue->id }}">
                                        ...
                                        <a href="modal" data-toggle="modal" data-target="#update-wedding-ceremonial-venue-{{ $ceremony_venue->id }}">
                                                    ...
                                                    <div class="card-text">
                                                        <div class="row ">
                                                            <div class="col-sm-12 text-center">
                                                                ...
                                                                <p>{{ dateFormat($wedding_planner->wedding_date) }} | {{ date('H.i',strtotime($wedding_planner->slot)) }} - {{ date('H.i',strtotime('+2 hours',strtotime($wedding_planner->slot))) }}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        @if ($reception_venue)
                            <tr>
                                ...
                                <td class="pd-2-8 text-right">
                                    <div class="table-action">
                                        <a href="modal" data-toggle="modal" data-target="#detail-reception-venue-{{ $reception_venue->id }}">
                                            <i class="icon-copy fa fa-eye" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="@lang('messages.Detail')" aria-hidden="true"></i>
                                        </a>
                                        <a href="modal" data-toggle="modal" data-target="#update-wedding-reception-venue-{{ $reception_venue->id }}">
                                            <i class="icon-copy fa fa-pencil" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="@lang('messages.Edit')" aria-hidden="true"></i>
                                        </a>
                                                    ...
                                                    <div class="card-text">
                                                        <div class="row ">
                                                            <div class="col-sm-12 text-center">
                                                                ...
                                                                <p>{{ dateFormat($wedding_planner->dinner_venue_time_start) }} | {{ date('H.i',strtotime($wedding_planner->dinner_venue_time_start)) }} - {{ date('H.i',strtotime($wedding_planner->dinner_venue_time_end)) }}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="dinner_venue_time_start" class="form-control @error('dinner_venue_time_start') is-invalid @enderror" required>
                                                                    @php
                                                                        $wp_duration = $wedding_planner->duration+1;
                                                                    @endphp
                                                                    <option selected value="{{ $wedding_planner->dinner_venue_time_start }}">{{ dateFormat($wedding_planner->dinner_venue_time_start) }}</option>
                                                                    @for ($wp_day = 0; $wp_day < $wp_duration; $wp_day++)
                                                                        <option value="{{ dateFormat('+'.$wp_day.' days',strtotime($wedding_planner->checkin)) }}">
                                                                            {{ dateFormat('+'.$wp_day.' days',strtotime($wedding_planner->checkin)) }}
                                                                            @if ( dateFormat('+'.$wp_day.' days',strtotime($wedding_planner->checkin)) == dateFormat($wedding_planner->checkin))
                                                                                - @lang('messages.Check-in')
                                                                            @endif
                                                                            @if ( dateFormat('+'.$wp_day.' days',strtotime($wedding_planner->checkin)) == dateFormat($wedding_planner->wedding_date))
                                                                                - @lang('messages.Wedding Ceremony')
                                                                            @endif
                                                                            @if ( dateFormat('+'.$wp_day.' days',strtotime($wedding_planner->checkin)) == dateFormat($wedding_planner->checkout))
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="time" class="form-control @error('time') is-invalid @enderror" required>
            ...
            <div class="col-md-12 text-right">
                @if (!$wedding_planner->ceremonial_venue_id)
                    <a href="modal" data-toggle="modal" data-target="#add-wedding-ceremonial-venue">
                ...
                @if (!$wedding_planner->dinner_venue_id)
                    <a href="modal" data-toggle="modal" data-target="#add-wedding-reception-venue">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="dinner_venue_time_start" class="form-control @error('dinner_venue_time_start') is-invalid @enderror" required>
                                                        ...
                                                        @for ($day = 0; $day < $range; $day++)
                                                            <option value="{{ dateFormat('+'.$day.' days',strtotime($wedding_planner->checkin)) }}">
                                                                {{ dateFormat('+'.$day.' days',strtotime($wedding_planner->checkin)) }}
                                                                @if ( dateFormat('+'.$day.' days',strtotime($wedding_planner->checkin)) == dateFormat($wedding_planner->checkin))
                                                                    - @lang('messages.Check-in')
                                                                @endif
                                                                @if ( dateFormat('+'.$day.' days',strtotime($wedding_planner->checkin)) == dateFormat($wedding_planner->wedding_date))
                                                                    - @lang('messages.Wedding Ceremony')
                                                                @endif
                                                                @if ( dateFormat('+'.$day.' days',strtotime($wedding_planner->checkin)) == dateFormat($wedding_planner->checkout))
                                                                    - @lang('messages.Check-out')
                                                                @endif
                                                            </option>
                                                        @endfor
