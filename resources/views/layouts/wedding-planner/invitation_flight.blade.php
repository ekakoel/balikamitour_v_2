    ...
    @if (count($flight_invitations)>0)
            ...
            <tbody>
                @foreach ($flight_invitations as $fl_no=>$flight_invitation)
                    ...
                    <tr>
                        ...
                        <td class="pd-2-8">
                            {{ dateTimeFormat($flight_invitation->time) }}
                        </td>
                        <td class="pd-2-8">
                        ...
                        <td class="pd-2-8 text-right">
                            <div class="table-action">
                                <a href="modal" data-toggle="modal" data-target="#update-flight-invitation-{{ $flight_invitation->id }}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"  readonly name="time" class="form-control datetimepicker @error('time') is-invalid @enderror"  placeholder="@lang('messages.Select date and time')" value="{{ dateTimeFormat($flight_invitation->time) }}" required>
                                                    @error('time')
                                                        <span class="invalid-feedback">
                                                            {{ $message }}
                                                        </span>
        ...
        <div class="row">
            <div class="col-md-12 text-right">
                <a href="modal" data-toggle="modal" data-target="#add-flight-invitation-{{ $wedding_planner->id }}">
