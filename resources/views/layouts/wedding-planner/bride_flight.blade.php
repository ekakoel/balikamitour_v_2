    ...
    <div class="col-md-12">
        @if ($wedding_planner->arrival_flight)
            <div class="page-subtitle m-b-8">@lang('messages.Flight Schedule') (@lang("messages.Bride"))
                <span>
                    <a href="modal" data-toggle="modal" data-target="#update-flight-bride-{{ $wedding_planner->id }}"> 
        ...
        @else
            <div class="page-subtitle m-b-8">@lang('messages.Flight Schedule') (@lang("messages.Bride"))
                <span>
                    <a href="modal" data-toggle="modal" data-target="#add-flight-bride-{{ $wedding_planner->id }}"> 
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly name="arrival_time" class="form-control datetimepicker @error('arrival_time') is-invalid @enderror"  placeholder="@lang('messages.Select date and time')" value="{{ dateTimeFormat($wedding_planner->arrival_time) }}" required>
                                        @error('arrival_time')
                                            <span class="invalid-feedback">
                                                {{ $message }}
                                            </span>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly name="departure_time" class="form-control datetimepicker @error('departure_time') is-invalid @enderror"  placeholder="@lang('messages.Select date and time')" value="{{ dateTimeFormat($wedding_planner->departure_time) }}" required>
