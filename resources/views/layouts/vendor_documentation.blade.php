...
@if (count($package_documentations)>0)
    ...
    <div class="card-box-content">
        @foreach ($package_documentations as $docno=>$package_documentation)
            ...
            @endphp
            <div class="card">
                <a href="modal" data-toggle="modal" data-target="#detail-package-{{ $package_documentation->id }}">
                ...
                <div class="price-card m-t-8">
                    {{"$ " . number_format($package_documentation->publish_rate, 0, ",", ".") }}
                </div>
                @canany(['posDev','weddingDvl','weddingAuthor'])
                    <div class="card-delete-btn">
                        <a href="modal" data-toggle="modal" data-target="#edit-package-{{ $package_documentation->id }}">
                                    ...
                                    <div class="card-text">
                                        ...
                                        <div class="row ">
                                            <div class="col-6 col-sm-4 m-b-8">
                                                ...
                                                <div class="idr-rate">{{ "Rp ".number_format($package_documentation->contract_rate, 0, ",", ".") }}</div>
                                                <div class="rate-usd">{{ "$ ".number_format($documentation_cr_usd, 0, ",", ".") }}</div>
                                            </div>
                                            <div class="col-6 col-sm-4 m-b-8">
                                                <div class="card-subtitle">Markup</div>
                                                <div class="idr-rate">{{ "Rp ".number_format($documentation_mr_idr, 0, ",", ".") }}</div>
                                                <div class="rate-usd">{{ "$ ".number_format($package_documentation->markup, 0, ",", ".") }}</div>
                                            </div>
                                            <div class="col-6 col-sm-4 m-b-8">
                                                <div class="card-subtitle">Tax {{ $tax->tax."%" }}</div>
                                                <div class="idr-rate">{{ "Rp ".number_format($documentation_tax_idr, 0, ",", ".") }}</div>
                                                <div class="rate-usd">{{ "$ ".number_format($documentation_tax, 0, ",", ".") }}</div>
                                            </div>
                                            <div class="col-6 col-sm-4 m-b-8">
                                                <div class="card-subtitle">Publish Rate</div>
                                                <div class="idr-rate">{{ "Rp ".number_format($documentation_publish_idr, 0, ",", ".") }}</div>
                                                <div class="usd-rate">{{ "$ ".number_format($package_documentation->publish_rate, 0, ",", ".") }}</div>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="status"  type="text" class="form-control @error('status') is-invalid @enderror" placeholder="Select status" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <select name="hotel_id" id="hotel_id"  type="text" class="form-control @error('type') is-invalid @enderror" placeholder="Select hotel_id">
                                                    @if ($package_documentation_hotel)
                                        ...
                                        <div class="col-12 col-sm-6 col-md-6">
                                            <div class="form-group ">
                                                ...
                                                <select id="documentationType" name="type" type="text" class="form-control @error('type') is-invalid @enderror" placeholder="Select type" required>
                                        ...
                                        <div id="documentationContainer" class="col-12 col-sm-6 col-md-6 hidden">
                                            <div class="form-group ">
                                                ...
                                                <select name="venue" type="text" class="form-control @error('venue') is-invalid @enderror" placeholder="Select venue">
                                        ...
                                        <div class="col-6 col-sm-3 col-md-3">
                                            <div class="form-group ">
                                                ...
                                                <select name="time" id="time"  type="text" class="form-control @error('type') is-invalid @enderror" placeholder="Select time" required>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" id="update-description-package{{ ++$docno }}" wire:model="description" class="ckeditor form-control @error('description') is-invalid @enderror" placeholder="Description" type="text">{!! $package_documentation->description !!}</textarea>
                                                @error('description')
                                                    <span class="invalid-feedback">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
