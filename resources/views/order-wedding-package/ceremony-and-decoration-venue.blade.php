            ...
            @if ($orderWedding->service != "Wedding Package")
                @if ($orderWedding->service != "Ceremony Venue")
                    @if ($orderWedding->ceremony_venue_id)
                        <span>
                            <form action="/fdelete-ceremony-venue/{{ $orderWedding->id }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="btn-icon">
                                                    ...
                                                    @if ($orderWedding->wedding_date)
                                                        <input readonly name="wedding_date" type="text" class="form-control input-icon date-picker @error('wedding_date') is-invalid @enderror" placeholder="Select Date" value="{{ dateFormat($orderWedding->wedding_date) }}" required>
                                                    @else
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="btn-icon">
                                                ...
                                                <input name="number_of_invitation" type="number" class="form-control input-icon @error('number_of_invitation') is-invalid @enderror" placeholder="Number of invitations" value="{{ $orderWedding->number_of_invitation }}" required>
                                            </div>
            ...
            @if ($ceremonyVenue)
                @if (count($cv_decorations)>0)
                    @if ($orderWedding->ceremony_venue_decoration_id)
                        @if ($orderWedding->service != "Wedding Package")
                            <span>
                                <form action="/fdelete-decoration-ceremony-venue/{{ $orderWedding->id }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                    <button class="icon-btn-remove" onclick="return confirm('Are you sure?');" type="submit" data-toggle="tooltip" data-placement="top" title="Remove"><i class="icon-copy fa fa-trash"></i></button>
                                </form>
