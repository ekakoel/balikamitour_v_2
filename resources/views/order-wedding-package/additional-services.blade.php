...
<div id="requestServices" class="col-md-12">
    ...
    <div class="page-subtitle">
        ...
        <span>
            <a href="modal" data-toggle="modal" data-target="#add-order-wedding-additional-service-{{ $orderWedding->id }}">
                ...
                <tr>
                    ...
                    <td class="pd-2-8 text-right">
                        <div class="table-action">
                            <a href="modal" data-toggle="modal" data-target="#update-order-wedding-request-service-{{ $additional_service->id }}">
