...
<div id="flightSchedule" class="col-md-12">
    @if (count($flights)>0)
        <div class="page-subtitle m-b-8">@lang('messages.Flight Schedule')
            <span>
                <a href="modal" data-toggle="modal" data-target="#add-wedding-flight-{{ $orderWedding->id }}"> 
                                ...
                                <tr>
                                    <td class="pd-2-8">
                                        @if ($order_wedding_flight->time)
                                                {{ dateFormat($order_wedding_flight->time) }}
                                            @else
                                                -
                                            @endif
                                    </td>
                                    ...
                                    <td class="pd-2-8 text-right">
                                        <div class="table-action">
                                            <a href="modal" data-toggle="modal" data-target="#update-order-wedding-flight-{{ $order_wedding_flight->id }}"> 
