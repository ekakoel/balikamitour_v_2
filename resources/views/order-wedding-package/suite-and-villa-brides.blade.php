...
<div id="suiteAndVillaBrides" class="col-md-6">
    <div class="page-subtitle">
        ...
        <span>
            <a href="modal" data-toggle="modal" data-target="#detail-bride-suite-villa-{{ $orderWedding->id }}"> 
            ...
            <div class="modal-content text-left">
                <div class="card-box">
                    <div class="card-box-title">
                        <div class="subtitle"><i class="icon-copy fa fa-building"></i>@lang('messages.Suite') / @lang('messages.Villa') (@lang("messages.Bride's"))</div>
                    </div>
