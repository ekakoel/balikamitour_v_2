                ...
                <div class="row">
                    <div id="term-and-condition" class="col-md-12">
                        <div class="card-box">
                                    ...
                                    <div class="isi-term">
                                        @foreach ($tandcs as $user_term)
                                            <div class="term-subtitle {{ $user_term->status == "Draft"?"text-grey":""; }}">
                                                {{ $user_term->name_en }}
                                                <div class="act-btn">
                                                    <a href="modal" data-toggle="modal" data-target="#edit-user-{{ $user_term->id }}"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="Edit" ></i></a>
                                    ...
                                    <div class="isi-term">
                                        @foreach ($system_term as $sys_term)
                                            <div class="term-subtitle {{ $sys_term->status == "Draft"?"text-grey":""; }}">
                                                {{ $sys_term->name_en }}
                                                <div class="act-btn">
                                                    <a href="modal" data-toggle="modal" data-target="#edit-system-{{ $sys_term->id }}"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="Edit" ></i></a>
                                    ...
                                    <div class="isi-term">
                                        @foreach ($admin_term as $adm_term)
                                            <div class="term-subtitle {{ $adm_term->status == "Draft"?"text-grey":""; }}">
                                                {{ $adm_term->name_en }}
                                                <div class="act-btn">
                                                    <a href="modal" data-toggle="modal" data-target="#edit-admin-{{ $adm_term->id }}"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="Edit" ></i></a>
                                    ...
                                    <div class="isi-term">
                                        @foreach ($price_term as $prs_term)
                                            <div class="term-subtitle {{ $prs_term->status == "Draft"?"text-grey":""; }}">
                                                {{ $prs_term->name_en }}
                                                <div class="act-btn">
                                                    <a href="modal" data-toggle="modal" data-target="#edit-price-{{ $prs_term->id }}"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="Edit" ></i></a>
                                    ...
                                    <div class="isi-term">
                                        @foreach ($currency_term as $curr_term)
                                            <div class="term-subtitle {{ $curr_term->status == "Draft"?"text-grey":""; }}">
                                                {{ $curr_term->name_en }}
                                                <div class="act-btn">
                                                    <a href="modal" data-toggle="modal" data-target="#edit-currency-{{ $curr_term->id }}"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="Edit" ></i></a>
                                    ...
                                    <div class="isi-term">
                                        @foreach ($promotion_term as $promo_term)
                                            <div class="term-subtitle {{ $promo_term->status == "Draft"?"text-grey":""; }}">
                                                {{ $promo_term->name_en }}
                                                <div class="act-btn">
                                                    <a href="modal" data-toggle="modal" data-target="#edit-promotion-{{ $promo_term->id }}"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="Edit" ></i></a>
                            ...
                            <div class="card-box-footer">
                                <a href="modal" data-toggle="modal" data-target="#add-new-policy"><button type="submit" class="btn btn-primary"><i class="icon-copy fa fa-plus" aria-hidden="true"></i> Add New Policy</button></a>
                            </div>
