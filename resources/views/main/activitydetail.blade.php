                        ...
                        <div class="card-box-footer">
                            @if ($activity->cancellation_policy > 0)
                                <div class="btn-cancelation-policy" data-toggle="tooltip" data-placement="left" title="@lang('messages.Cancelation Policy')">
                                    <a href="modal" data-toggle="modal" data-target="#cancellation-policy-{{ $activity->id }}">
                                        <i class="icon-copy fa fa-info" aria-hidden="true"></i>
                                    </a>
                                </div>
                            @endif
                            <a href="modal" data-toggle="modal" data-target="#order-activity-{{ $activity->id }}">
                                ...
                                <div class="modal-content">
                                    <div class="card-box">
                                        ...
                                        <form id="create-order" action="/fadd-order" method="POST">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="custom-select" style="width: 100%">
                                                                    <select name="user_id" class="@error('user_id') is-invalid @enderror" value="{{ old('user_id') }}" required>
                                            ...
                                            <input type="hidden" name="checkin" value="{{ dateFormat('+2 month', strtotime($now)) }}">
