                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 m-b-18">
                        <div class="card-box align-content-center">
                            ...
                            <div class="edit-btn-pencil" data-toggle="tooltip" data-placement="top" title="@lang('messages.Change Profile Picture')">
                                <a href="modal" data-toggle="modal" data-target="#editProfilePicture" class="edit-avatar"><i class="fa fa-pencil"></i></a>
                            </div>
                            {{-- MODAL --}}
                            ...
                            @if (Auth::user()->status != "Block")
                                <div class="card-box-footer">
                                    {{-- @if (Auth::user()->is_approved != 1) --}}
                                        <a href="modal" data-toggle="modal" data-target="#modal{{ Auth::user()->id }}">
                                            <button class="btn btn-primary"><i class="icon-copy fa fa-pencil" aria-hidden="true"></i> @lang('messages.Edit Profile')</button>
                                        </a>
                                    {{-- @endif --}}
                                    <a href="modal" data-toggle="modal" data-target="#update-password" class="edit-avatar"><button class="btn btn-primary"><i class="icon-copy fa fa-pencil" aria-hidden="true"></i> @lang('messages.Change Password')</button></a>
                                </div>
