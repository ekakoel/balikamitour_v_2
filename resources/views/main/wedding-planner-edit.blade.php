                    ...
                    <div class="col-md-8">
                        <div class="card-box m-b-18">
                                                        ...
                                                        <div class="card-text">
                                                            <div class="row ">
                                                                <div class="col-sm-12 text-center">
                                                                    ...
                                                                    <p>{{ dateFormat($wedding_planner->checkin) }} | {{ dateFormat($wedding_planner->checkout) }}</p>
                                                                    <p>
                            ...
                            {{-- <table class="w-100 m-b-18">
                                ...
                                <tr>
                                    <td colspan="4" class="tb-bordered text-center f-w-700">{{ dateFormat($wedding_planner->wedding_date)." (".date('H.i',strtotime($wedding_planner->slot))." - ".date('H.i',strtotime('+2 hours',strtotime($wedding_planner->slot))).")" }}</td>
                                </tr>
                                <tr>
                            ...
                            @if (dateFormat($wedding_planner->checkin) > dateFormat($wedding_planner->wedding_date) or dateFormat($wedding_planner->checkout) < dateFormat($wedding_planner->wedding_date) or dateFormat($wedding_planner->checkin) >= dateFormat($wedding_planner->checkout) or !$wedding_planner->ceremonial_venue_id)
                                <div class="card-box-notification">
                                    ...
                                    @endif
                                    @if (dateFormat($wedding_planner->checkin) >= dateFormat($wedding_planner->checkout))
                                        <p><b>"@lang('messages.Check-in')"</b> -> @lang('messages.Check-in date or Check-out date is invalid')</p>
                                    @endif
                                    @if (dateFormat($wedding_planner->checkin) > dateFormat($wedding_planner->wedding_date) or dateFormat($wedding_planner->checkout) < dateFormat($wedding_planner->wedding_date))
                            ...
                            @if ($wedding_planner->status == "Draft")
                                <div class="card-box-footer">
                                    @if (dateFormat($wedding_planner->checkin) < dateFormat($wedding_planner->wedding_date) and dateFormat($wedding_planner->checkout) > dateFormat($wedding_planner->wedding_date))
                                        @if ($wedding_planner->ceremonial_venue_id)
