                                        ...
                                        <div class="col-md-12">
                                            <div class="row m-b-8">
                                                ...
                                                <div class="col-md-6 text-right">
                                                    <a href="modal" data-toggle="modal" data-target="#add-optional-rate-{{ $order->id }}">
                                            ...
                                            <table id="tbHotels" class="data-table table nowrap" >
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($optional_rate as $optionalrate)
                                                        ...
                                                        <tr>
                                                            <td>
                                                                {{ dateFormat($optionalrate->service_date) }}
                                                            </td>
                                                            <td>
                                                                {{ $optionalrate->name }}
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div class="row">
                                                                    <div class="col-2">
                                                                        <a href="modal" data-toggle="modal" data-target="#edit-opser-{{ $optionalrate->id }}">
                                                                            ...
                                                                            <div class="col-12">
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-6">
                                                                                        ...
                                                                                        <p><b>Check-in: </b> {{ dateFormat($order->checkin)}}</p>
                                                                                        <p><b>Check-out: </b> {{ dateFormat($order->checkout)}}</p>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-12">
