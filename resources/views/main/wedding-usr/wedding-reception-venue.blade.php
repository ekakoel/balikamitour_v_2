    ...
    @if ($hotel->reception_venues)
        <div class="card-box-content">
            @foreach ($hotel->reception_venues as $rec_no=>$reception_venue)
                <div class="card">
                    <a href="modal" data-toggle="modal" data-target="#detail-dinner-package-{{ $reception_venue->id }}">
                    ...
                    <div class="card-button-container">
                        <a href="modal" data-toggle="modal" data-target="#order-reception-venue-{{ $reception_venue->id }}">
                        ...
                        @if (count($wedding_planner_reception_venue_none)>0)
                            <a href="modal" data-toggle="modal" data-target="#add-reception-venue-to-wedding-planner-{{ $reception_venue->id }}">
