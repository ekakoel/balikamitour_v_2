        ...
        <div id="weddingPackages" class="card-box-content">
            @foreach ($weddingPackages as $wedding_package)
                ...
                <div class="card" role="tabpanel">
                    <a href="modal" data-toggle="modal" data-target="#detail-wedding-package-{{ $wedding_package->id }}">
                    ...
                    <div class="card-button-container">
                        <a href="modal" data-toggle="modal" data-target="#order-wedding-package-venue-{{ $wedding_package->id }}">
