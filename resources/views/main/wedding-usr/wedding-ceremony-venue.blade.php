    ...
    <div class="card-box-content">
        @foreach ($weddingVenues as $index => $ceremony_venue)
            ...
            <div class="card" role="tabpanel">
                <a href="modal" data-toggle="modal" data-target="#detail-wedding-venue-{{ $ceremony_venue->id }}">
                ...
                <div class="card-button-container text-right">
                    <a href="modal" data-toggle="modal" data-target="#order-wedding-venue-{{ $ceremony_venue->id }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control input-icon selectInput @error('slot') is-invalid @enderror"
                                                id="slot_{{ $index }}"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-8">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control input-icon @error('wedding_planner') is-invalid @enderror" name="wedding_planner_id" required>
                                                    ...
                                                    @endphp
                                                        <option value="{{ $wpcvn->id }}">
                                                            ...
                                                            @if ($wpcvn->wedding_date > $now)
                                                                - @lang('messages.Wedding Date'): {{ dateFormat($wpcvn->wedding_date) }}
                                                            @endif
                                                        </option>
                                                    @endforeach
                                                </select>
