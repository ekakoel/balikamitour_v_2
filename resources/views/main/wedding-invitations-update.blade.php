@section('title','Wedding Invitation Update')
@section('content')
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="table-action">
                                                            <a href="modal" data-toggle="modal" data-target="#update-invitation-{{ $invitation->id }}">
                                                                            ...
                                                                            <div class="row ">
                                                                                ...
                                                                                <div class="col-md-4">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="btn-icon">
                                                                                            <select name="country" class="form-control @error('country') is-invalid @enderror" value="{{ old('country') }}" required>
