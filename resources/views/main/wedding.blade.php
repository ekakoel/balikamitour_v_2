                    ...
                    <div class="page-header">
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <div class="title"><i class="icon-copy fa fa-building-o"></i>&nbsp; @lang('messages.Wedding Venues')</div>
                ...
                <div class="col-md-12">
                    <div class="card-box">
                        <div class="card-box-title">
                            <div class="subtitle"><i class="icon-copy fa fa-building"></i> @lang("messages.Wedding Venues")</div>
                        </div>
