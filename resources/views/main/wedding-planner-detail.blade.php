@section('title','Wedding Planner Detail')
@section('content')
                        ...
                        <div class="card-box m-b-18">
                            ...
                            <div class="product-detail-wrap">
                                    ...
                                    <div class="col-sm-6">
                                        <table class="table tb-list">
                                            ...
                                            <tr>
                                                ...
                                                <td class="htd-2">{{ dateFormat($wedding_planner->created_at) }}</td>
                                            </tr>
                                            <tr>
                                ...
                                {{-- <table class="w-100 m-b-18">
                                    ...
                                    <tr>
                                        <td colspan="2" class="tb-bordered">
                                            ...
                                            @if ($wedding_planner->arrival_flight)
                                                {{ $wedding_planner->arrival_flight }} {{ dateTimeFormat($wedding_planner->arrival_time) }}
                                            @else
                                                -
                                            @endif
                                        </td>
                                        <td colspan="2" class="tb-bordered">
                                            ...
                                            @if ($wedding_planner->departure_flight)
                                                {{ $wedding_planner->departure_flight }} {{ dateTimeFormat($wedding_planner->departure_time) }}
                                            @else
                                                -
                                            @endif
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="4" class="tb-bordered text-center f-w-700">{{ dateFormat($wedding_planner->wedding_date)." (".dateFormat($wedding_planner->slot)." - ".dateFormat('+2 hours',strtotime($wedding_planner->slot)).")" }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr style="height: 100px">
                                        ...
                                        <td colspan="2" class="tb-bordered">
                                            ...
                                            <b>@lang('messages.Field of Business'): </b>{{ $business->caption }}<br>
                                    ...
                                    <div class="col-12">
                                        @if (isset($wedding_planner->arrival_flight)  or isset($wedding_planner->arrival_time) or isset($wedding_planner->departure_flight) or isset($wedding_planner->departure_time))
                                            <div class="page-subtitle m-b-8">@lang('messages.Flight')
                                                <span>
                                                    <a href="modal" data-toggle="modal" data-target="#add-flight-{{ $wedding_planner->id }}"> 
                                                ...
                                                <div class="col-md-6">
                                                    <table class="table tb-list" >
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="htd-2">
                                                                {{ dateTimeFormat($wedding_planner->arrival_time) }}
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                                                <div class="col-md-6">
                                                    <table class="table tb-list" >
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="htd-2">
                                                                {{ dateTimeFormat($wedding_planner->departure_time) }}
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" readonly name="arrival_time" class="form-control datetimepicker @error('arrival_time') is-invalid @enderror"  placeholder="@lang('messages.Select date and time')" value="{{ dateFormat($wedding_planner->arrival_time) }}" required>
                                                                        @error('arrival_time')
                                                                            <span class="invalid-feedback">
                                                                                {{ $message }}
                                                                            </span>
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" readonly name="departure_time" class="form-control datetimepicker @error('departure_time') is-invalid @enderror"  placeholder="@lang('messages.Select date and time')" value="{{ dateFormat($wedding_planner->departure_time) }}" required>
                                   ...
                                   {{-- COUPLE --}}
                                    <div class="col-md-12">
                                        <div class="page-subtitle">
                                            ...
                                            <span>
                                                <a href="modal" data-toggle="modal" data-target="#update-couple-{{ $wedding_planner->id }}"> 
                                    ...
                                    <div class="col-md-12">
                                        <div class="page-subtitle">
                                            @lang("messages.Wedding")
                                            <span>
                                                <a href="modal" data-toggle="modal" data-target="#update-wedding-date-{{ $wedding_planner->id }}"> 
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select name="slot" class="form-control @error('slot') is-invalid @enderror" required>
                                                                                ...
                                                                                @foreach ($slots as $slot)
                                                                                    <option value="{{ $slot }}">{{ dateFormat($slot) }}</option>
                                                                                @endforeach
                                                                            </select>
                                                                            @error('slot')
                                            ...
                                            <div class="col-md-6">
                                                <table class="table tb-list" >
                                                    <tr>
                                                        ...
                                                        @if ($wedding_planner->slot)
                                                            <td class="htd-2">
                                                                {{ dateFormat($wedding_planner->wedding_date)." ".date('(H.i A)',strtotime($wedding_planner->slot)) }}
                                                            </td>
                                                        @else
                                                            <td class="htd-2 page-notification">
                                                                {{ dateFormat($wedding_planner->wedding_date) }} (--:--)
                                                            </td>
                                                        @endif
                                                    </tr>
                                                </table>
                                    ...
                                    <div class="col-md-12">
                                        <div class="page-subtitle">
                                            ...
                                            <span>
                                                <a href="modal" data-toggle="modal" data-target="#wedding-package-{{ $wedding_package->id }}">
                                            ...
                                            <div class="col-md-6">
                                                <table class="table tb-list" >
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="htd-2">
                                                            {{ dateFormat($wedding_planner->slot) }}
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <table class="table tb-list" >
                                                    <tr>
                                                        ...
                                                        <td class="htd-2">
                                                            {{ dateFormat($wedding_planner->checkin) }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="htd-1">
                                                        ...
                                                        <td class="htd-2">
                                                            {{ dateFormat($wedding_planner->checkout) }}
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
