                ...
                <div class="card-box p-b-18">
                    ...
                    <div class="page-card">
                        ...
                        <div class="card-content">
                            <div class="row">
                                <div class="col-6">
                                    <div class="card-subtitle"><i class="icon-copy fa fa-building" aria-hidden="true"></i>@lang('messages.Hotel'):</div>
                                    <p>{{  $hotel->name  }}</p>
                                </div>
                                <div class="col-6">
                                ...
                                <div class="col-6">
                                    ...
                                    <p>{{  dateFormat($wedding->period_start)." - ".dateFormat($wedding->period_end) }} </p>
                                </div>
                            </div>
                            <div class="card-text">
                                <div class="row ">
                                    <div class="col-12">
                                        ...
                                        @foreach ($hotel->contract_wedding as $br_no=>$brochure)
                                            <a href="modal" data-target="#wedding-pdf-{{ $brochure->id }}" data-toggle="modal">
                                ...
                                @if ($wedding->suite_and_villas_id)
                                    @if ($snvs_id)
                                        @foreach ($snvs_id as $snv_id)
                                            ...
                                            @endphp
                                            <div class="card">
                                                <a href="modal" data-toggle="modal" data-target="#detail-suite_adn_room-{{ $suite_adn_room->id }}">
                                                    <div class="image-container">
                                ...
                                @if ($wedding->decorations_id)
                                    @if ($decos)
                                        @foreach ($decos as $deco)
                                            ...
                                            @if ($decoration)
                                                <div class="card">
                                                    <a href="modal" data-toggle="modal" data-target="#detail-decoration-{{ $decoration->id }}">
                                                        <div class="image-container">
                                ...
                                @if ($wedding->dinner_venue_id)
                                    ...
                                    @foreach ($din_venues_id as $din_venue_id)
                                        <div class="card">
                                                ...
                                                @endphp
                                                <a href="modal" data-toggle="modal" data-target="#detail-dinner_venue-{{ $din_venue_id }}">
                                                    <div class="image-container">
                                ...
                                @if ($wedding->makeup_id)
                                    @if ($ms_id)
                                        @foreach ($ms_id as $m_id)
                                            ...
                                            @if ($makeup_artis)
                                                <div class="card">
                                                    <a href="modal" data-toggle="modal" data-target="#detail-makeup_artis-{{ $m_id }}">
                                                        <div class="image-container">
                                ...
                                @if ($wedding->entertainments_id)
                                    @if ($v_ids)
                                        @foreach ($v_ids as $v_id)
                                            ...
                                            @if ($ents)
                                                <div class="card">
                                                    <a href="modal" data-toggle="modal" data-target="#detail-ents-{{ $ents->id }}">
                                                        <div class="image-container">
                                ...
                                @if ($wedding->documentations_id)
                                    ...
                                    @if ($doc_ids)
                                        @foreach ($doc_ids as $doc_id)
                                            ...
                                            @endphp
                                            <div class="card">
                                                <a href="modal" data-toggle="modal" data-target="#detail-documentations-{{ $documentation->id }}">
                                                    <div class="image-container">
                                ...
                                @if ($wedding->other_service_id)
                                    @if ($ot_ser_ids)
                                        @foreach ($ot_ser_ids as $ot_ser_id)
                                            ...
                                            @if ($other_service)
                                                <div class="card">
                                                    <a href="modal" data-toggle="modal" data-target="#detail-other_service-{{ $other_service->id }}">
                                                        <div class="image-container">
