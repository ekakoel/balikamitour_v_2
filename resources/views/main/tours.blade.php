                                ...
                                <div class="bookingcode-card">
                                    ...
                                    <div class="content-card-promo">
                                        ...
                                        <button class="btn-remove-code" data-toggle="tooltip" data-placement="top"
                                            title='@lang('messages.Ongoing promotion'){{ ' ' . $promotion->name . ' ' }}@lang('messages.and get discounts'){{ " $" . $promotion->discounts . ' ' }}@lang('messages.until'){{ ' ' . dateFormat($promotion->periode_end) }}'><i
                ...
                <div class="col-md-12">
                    <div class="card-box">
                        <div class="card-box-title">
                            <div class="subtitle"><i class="fa fa-suitcase"></i> @lang('messages.Tour Package')</div>
                        </div>
