                        ...
                        <div class="col-md-8">
                            <div class="card-box">
                                    ...
                                    <table id="tbHotels" class="data-table table stripe hover nowrap dataTable">
                                        ...
                                        <tbody>
                                            @foreach ($wedding_planners as $no=>$wedding_planner)
                                                <tr>
                                                    <td>
                                                        {{ dateFormat($wedding_planner->wedding_date) }}<br>
                                ...
                                <div class="card-box-footer">
                                    <a href="modal" data-toggle="modal" data-target="#add-new-wedding-planner"><button class="btn btn-primary"><i class="ion-plus-round"></i> @lang('messages.New Wedding Planner')</button></a>
                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control input-icon @error('hotel_id') is-invalid @enderror" id="hotel_id" name="hotel_id" required>
