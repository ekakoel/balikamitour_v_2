            ...
            <div class="lang-dropdown m-r-18">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                        <a class="dropdown-item" href="{{ url('lang/en') }}"><i class="fa fa-language" aria-hidden="true"></i>English</a>
                        <a class="dropdown-item" href="{{ url('lang/zh') }}"><i class="fa fa-language" aria-hidden="true"></i> 繁體中文 (Chinese Traditional)</a>
                        <a class="dropdown-item" href="{{ url('lang/zh-CN') }}"><i class="fa fa-language" aria-hidden="true"></i> 简体中文 (Chinese Simplified)</a>
                    </div>
                </div>
            </div>
        </a>
