                    ...
                    <div class="col-md-12">
                        <form action="{{ route('hotels.prices',$hotel->code) }}" method="POST" role="search">
                            ...
                            <div class="form-group">
                                <input readonly id="checkincout" name="checkincout" class="form-control @error('checkincout') is-invalid @enderror" type="text" value="{{ date('m/d/Y',strtotime($checkin))." - ".date('m/d/Y',strtotime($checkout)) }}" placeholder="@lang('messages.Check In') - @lang('messages.Check Out')" required>
                                @error('checkincout')
