                    ...
                    <div class="page-header">
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <div class="title"><i class="icon-copy fa fa-building-o"></i>&nbsp; @lang('messages.Order') - {{ $orderno }}</div>
                                    ...
                                    <div class="modal-footer">
                                        <div class="form-group">
                                            ...
                                            @elseif ($service == "Hotel Promo")
                                                ...
                                                <input type="hidden" name="book_period_start" value="{{ dateFormat($promo->book_periode_start) }}">
                                                <input type="hidden" name="book_period_end" value="{{ dateFormat($promo->book_periode_end) }}">
                                                <input type="hidden" name="period_start" value="{{ dateFormat($promo->periode_start) }}">
                                                <input type="hidden" name="period_end" value="{{ dateFormat($promo->periode_end) }}">
                                                <input type="hidden" name="include" value="{!! $promo->include !!}">
                                                <input type="hidden" name="additional_info" value="{{ $promo->additional_info }}">
                                            @elseif ($service == "Hotel Package")
                                                <input type="hidden" name="period_start" value="{{ dateFormat($package->stay_period_start) }}">
                                                <input type="hidden" name="period_end" value="{{ dateFormat($package->stay_period_end) }}">
