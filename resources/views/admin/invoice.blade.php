                                ...
                                <div class="row">
                                    <div class="input-group">
                                        ...
                                        <div class="col-md-6 p-b-8">
                                            ...
                                            <input id="searchInvByNo" type="text" onkeyup="searchTable('searchInvByNo','tb_inv',1)" class="form-control" name="search-byno" placeholder="Find Invoice by No">
                                        </div>
                                        <div class="col-md-6 p-b-8">
                                            <span class="input-group-addon"><i class="icon-copy fa fa-search" aria-hidden="true"></i></span>
                                            <input id="searchInvByAgn" type="text" onkeyup="searchTable('searchInvByNo','tb_inv',2)" class="form-control" name="search-byagn" placeholder="Sort Infoice by agent">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    @endphp
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row">
                                                    <div class="col-2">
                                                        <a href="modal" data-toggle="modal" data-target="#invoice-{{ $inv->id }}"> <button class="btn-view" data-toggle="tooltip" data-placement="top" title="Detail Invoice"><i class="icon-copy fa fa-eye" aria-hidden="true"></i></button></a>
                                                    </div>
                                                    <div class="col-2">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 text-right">
                                                        <div class="inv-head-con">
                                                            ...
                                                            <p>{{ 'Invoice Date: '. dateFormat($inv->created_at) }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-8">
                                                                    ...
                                                                    <div class="order-list-value">
                                                                        {{ dateFormat($inv->created_at) }}
                                                                    </div>
                                                                    <div class="order-list-value">
                                                                        <?php 
                                                                            $datenow = date('ymd', strtotime($now));
                                                                            $inv_date = date("ymd", strtotime($inv->created_at));
                                                                            $duedate = date("ymd", strtotime('+'.$inv->due_date.'days', strtotime($inv->created_at)));
                                                                            $day_left = $duedate-$datenow;
                                                                        ?>
                                                                        {{ date("ymd", strtotime($duedate)) }}<br>
                                                                        {{-- {{ $inv_date }}<br>
                                                                        
                                                                        {{ $inv->due_date }}
                                                                        {{ $day_left }} --}}
                                                                        {{-- {{ dateFormat($duedate)) }}<r> --}}
                                                                        {{ date('ymd', strtotime($duedate)).' ('.$day_left.' days left)' }}
                                                                    </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                @if ($inv->service == "Hotel")
                                                                    ...
                                                                    <div class="col-6">
                                                                        ...
                                                                        <div class="order-list-value">{{ dateFormat($inv->checkin) }}</div>
                                                                        <div class="order-list-value">{{ dateFormat($inv->checkout) }}</div>
                                                                    </div>
                                                                @elseif ($inv->service == "Hotel Promo")
                                                                    <div class="col-6">
                                                                        <div class="order-list">Duration</div>
                                                                ...
                                                                @elseif ($inv->service == "Tour Package")
                                                                    ...
                                                                    <div class="col-6">
                                                                        ...
                                                                        <div class="order-list-value">{{ dateFormat($inv->travel_date) }}</div>
                                                                        <div class="order-list-value">
                                                                            @if ($inv->duration == "1D")
                                                                                <?php $tour_end=dateTimeFormat("+10 hours", strtotime($inv->travel_date)); ?>
                                                                                {{ dateFormat($tour_end) }}
                                                                            @elseif ($inv->duration == "2D/1N")
                                                                                <?php $tour_end=dateTimeFormat("+34 hours", strtotime($inv->travel_date)); ?>
                                                                                {{ dateFormat($tour_end) }}
                                                                            @elseif ($inv->duration == "3D/2N")
                                                                                <?php $tour_end=dateTimeFormat("+58 hours", strtotime($inv->travel_date)); ?>
                                                                                {{ dateFormat($tour_end) }}
                                                                            @elseif ($inv->duration == "4D/3N")
                                                                                <?php $tour_end=dateTimeFormat("+82 hours", strtotime($inv->travel_date)); ?>
                                                                                {{ dateFormat($tour_end) }}
                                                                            @elseif ($inv->duration == "5D/4N")
                                                                                <?php $tour_end=dateTimeFormat("+106 hours", strtotime($inv->travel_date)); ?>
                                                                                {{ dateFormat($tour_end) }}
                                                                            @elseif ($inv->duration == "6D/5N")
                                                                                <?php $tour_end=dateTimeFormat("+130 hours", strtotime($inv->travel_date)); ?>
                                                                                {{ dateFormat($tour_end) }}
                                                                            @elseif ($inv->duration == "7D/6N")
                                                                                <?php $tour_end=dateTimeFormat("+154 hours", strtotime($inv->travel_date)); ?>
                                                                                {{ dateFormat($tour_end) }}
                                                                            @else
                                                                            @endif
                                                                        </div>
                                                                    ...
                                                                    <div class="col-6">
                                                                        ...
                                                                        <div class="order-list-value">
                                                                            <?php
                                                                                ...
                                                                                $activity_end=dateTimeFormat('+'.$activity_duration.'hours', strtotime($inv->travel_date)); 
                                                                            ?>
                                                                    ...
                                                                    <div class="col-6">
                                                                        ...
                                                                        <div class="order-list-value">
                                                                            <?php 
                                                                                ...
                                                                                $return_date=dateTimeFormat( '+'.$duration.'days', strtotime($inv->travel_date));
                                                                            ?>
                                                                            {{ dateFormat($return_date) }}
                                                                        </div>
                                                                    </div>
                                                                @else
                                                                @endif
