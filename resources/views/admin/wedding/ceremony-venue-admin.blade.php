                    ...
                    <a href="modal" data-toggle="modal" data-target="#detail-wedding-venue-{{ $ceremony_venue->id }}">
                        <div class="card-image-container">
                            ...
                            <div class="card-period-full">
                                {{ dateFormat($ceremony_venue->periode_start) }} - {{ dateFormat($ceremony_venue->periode_end) }}
                            </div> 
                            <div class="name-card">
                                <p>
                                            ...
                                            <div class="card-ptext-margin">
                                                <div class="row ">
                                                    ...
                                                    <div class="col-6 col-sm-4">
                                                        ...
                                                        <p>{{ dateFormat($ceremony_venue->periode_start) }} - 
                                                        {{ dateFormat($ceremony_venue->periode_end) }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
