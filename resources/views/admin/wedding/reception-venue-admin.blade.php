...
<div id="receptionVenue" class="card-box">
                    ...
                    <a href="modal" data-toggle="modal" data-target="#detail-reception-venue-{{ $reception_venue->id }}">
                        <div class="card-image-container">
                            ...
                            <div class="card-period-full">
                                {{ dateFormat($reception_venue->periode_start) }} - {{ dateFormat($reception_venue->periode_end) }}
                            </div> 
                            <div class="name-card">
                                <p>
                                                ...
                                                <div class="card-ptext-margin">
                                                    <div class="row ">
                                                        ...
                                                        <div class="col-6 col-sm-3">
                                                            ...
                                                            <div class="usd-text">{{ dateFormat($reception_venue->periode_start) }} - {{ dateFormat($reception_venue->periode_end) }}</div>
                                                        </div>
                                                        <div class="col-6 col-sm-3">
    ...
    @endcanany
    <div class="card-box-footer">
        <a href="modal" data-toggle="modal" data-target="#add-reception-venue-{{ $hotel->id }}">
