                        ...
                        <div class="card-box">
                            ...
                            <div class="input-container">
                                <div class="input-group">
                                    ...
                                    <input id="searchUserByName" type="text" onkeyup="searchTable('searchUserByName','tbUsers',1)" class="form-control" name="search-user-byname" placeholder="Search by name">
                                </div>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="icon-copy fa fa-search" aria-hidden="true"></i></span>
                                    <input id="searchUserByGroup" type="text" onkeyup="searchTable('searchUserByGroup','tbUsers',2)" class="form-control" name="search-user-group" placeholder="Search by group">
                                </div>
                            </div>
                                        ...
                                        @foreach ($users as $no=>$user)
                                            ...
                                            <td class="text-right">
                                                <div class="table-action">
                                                    ...
                                                    @endif
                                                    <a href="modal" data-toggle="modal" data-target="#user-view-{{ $user->id }}">
                                                        <button class="btn-view"><i class="dw dw-eye"></i></button>
                                                    </a>
                                                    <a href="modal" data-toggle="modal" data-target="#user-edit-{{ $user->id }}">
                                        ...
                                        <div class="modal fade" id="user-view-{{ $user->id }}" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="card-box">
                                                        <div class="card-box-title">
                                                            <div class="title"><i class="icon-copy fa fa-user" aria-hidden="true"></i> User Detail</div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="row">
                                                                <div class="col-md-3">
                            ...
                            <div class="card-box-footer">
                                <a href="modal" data-toggle="modal" data-target="#user-add">
                            ...
                            <div class="modal fade" id="user-add" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="card-box">
                                            <div class="card-box-title">
                                                <div class="title"><i class="icon-copy fa fa-plus" aria-hidden="true"></i> Add New User</div>
                                            </div>
