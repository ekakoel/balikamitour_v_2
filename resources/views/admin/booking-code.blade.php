                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div id="activebookingcodes" class="card-box">
                                    ...
                                    <table id="tbPartners" class="data-table table stripe hover" >
                                        ...
                                        <tbody>
                                            @foreach ($bookingcodes as $no=>$bookingcode)
                                                @php
                                                    $exp_date = Carbon::parse($bookingcode->expired_date);
                                                ...
                                                <tr>
                                                    ...
                                                    @if ($bookingcode->status !== "Expired")
                                                        <td data-toggle="tooltip" data-placement="right" title="{{ "Expired in ".$wexpired." days" }}">
                                                    @else
                                                        <td data-toggle="tooltip" data-placement="right" title="{{ "Expired on ".dateFormat($bookingcode->expired_date) }}">
                                                    @endif
                                                        <p>{{ $bookingcode->code }}</p>
                                                    </td>
                                                    <td>
                                                        <p>{{ dateFormat($bookingcode->expired_date) }}</p>
                                                    </td>
                                                    <td>
                                                    ...
                                                    @canany(['posDev','posAuthor'])
                                                        <td class="text-right">
                                                            <div class="table-action">
                                                                <a href="modal" data-toggle="modal" data-target="#edit-bookingcode-{{ $bookingcode->id }}">
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-12 col-sm-4">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <input readonly type="text" id="expired_date" name="expired_date" class="form-control date-picker @error('expired_date') is-invalid @enderror" placeholder="Expired Date" value="{{ dateFormat($bookingcode->expired_date) }}" required>
                                                                                            @error('expired_date')
                                                                                                <div class="alert alert-danger">{{ $message }}</div>
                                                                                            @enderror
                                                                                        </div>
                                ...
                                @canany(['posDev','posAuthor'])
                                    <div class="card-box-footer">
                                        <a href="modal" data-toggle="modal" data-target="#add-bookingcode"><button class="btn btn-primary"><i class="ion-plus-round"></i> Create Booking Code</button></a>
                                    </div>
