                                ...
                                @if (count($promotions)>0)
                                    ...
                                    <table id="tbPartners" class="data-table table stripe hover" >
                                        ...
                                        <tbody>
                                            ...
                                            @php
                                                $exp_date = Carbon::parse($promotion->expired_date);
                                                $wexpired = $now->diffInDays($exp_date);
                                            @endphp
                                                <tr>
                                                    <td>
                                                        {{ ++$no }}
                                                    ...
                                                    <td>
                                                        <p>{{ dateFormat($promotion->periode_start) }}</p>
                                                    </td>
                                                    <td>
                                                        <p>{{ dateFormat($promotion->periode_end) }}</p>
                                                    </td>
                                                    <td>
                                                        ...
                                                        @else
                                                            <td class="text-right">
                                                                <div class="table-action">
                                                                    <a href="modal" data-toggle="modal" data-target="#detail-promotion-{{ $promotion->id }}">
                                                                        <button class="btn-edit" data-toggle="tooltip" data-placement="top" title="Detail"><i class="icon-copy fa fa-eye"></i></button>
                                                                    </a>
                                                                    @canany(['posDev','posAuthor'])
                                                                        <a href="modal" data-toggle="modal" data-target="#edit-promotion-{{ $promotion->id }}">
                                                                ...
                                                                <div class="card-box">
                                                                    ...
                                                                    <form id="update-promotion-{{ $promotion->id }}" action="/fupdate-promotion/{{ $promotion->id }}" method="post" enctype="multipart/form-data">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select name="status" id="status"  type="text" class="form-control @error('status') is-invalid @enderror" placeholder="Select status" required>
                                                                                @if ($promotion->status == "Draft")
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input readonly type="text" id="periode_start" name="periode_start" class="form-control date-picker @error('periode_start') is-invalid @enderror" placeholder="Start Period" value="{{ dateFormat($promotion->periode_start) }}" required>
                                                                            @error('periode_start')
                                                                                <div class="alert alert-danger">{{ $message }}</div>
                                                                            @enderror
                                                                        </div>
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input readonly type="text" id="periode_end" name="periode_end" class="form-control date-picker @error('periode_end') is-invalid @enderror" placeholder="End Period" value="{{ dateFormat($promotion->periode_end) }}" required>
                                                                            @error('periode_end')
                                                                                <div class="alert alert-danger">{{ $message }}</div>
                                                                            @enderror
                                                                        </div>
                                    ...
                                    <div class="card-box-footer">
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 text-right">
                                                <a href="modal" data-toggle="modal" data-target="#add-promotion"><button class="btn btn-primary"><i class="ion-plus-round"></i> Create Promotion</button></a>
                                            </div>
                                        </div>
                                    </div>
                                    {{-- MODAL ADD PROMOTION --------------------------------------------------------------------------------------------------------------- --}}
