                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card-box">
                            ...
                            <form id="update-order-room" action="/fadmin-update-order-room/{{ $order->id }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                {{ csrf_field() }}
                                <div class="row">
                                                ...
                                                @for ($i = 0; $i < $nor; $i++)
                                                    <li class="m-b-8">
                                                        <div class="control-group">
                                                            @if ($nogr[$i] > 2 and $extra_bed_id[$i] == 0)
                                                                <div class="room-container-error">
                                                            @else
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="number" min="1" max="4" name="number_of_guests_room[]" class="form-control m-0 @error('number_of_guests_room[]') is-invalid @enderror" placeholder="Number of guests" value="{{ $nogr[$i] }}" required>
                                        ...
                                        <div class="room-container ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <label for="number_of_guests_room[]">Number of Guests</label>
                                                        <input type="number" min="1" max="4" name="number_of_guests_room[]" class="form-control m-0 @error('number_of_guests_room[]') is-invalid @enderror" placeholder="Number of guests" required>
                                                        @error('number_of_guests_room[]')
                                                            <div class="alert alert-danger">
                                                                {{ $message }}
                                                            </div>
