                                        ...
                                        <form action="/fupdate-reservation/{{ $reservation->id }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-8">
                                                    ...
                                                    <div class="page-list-value">
                                                        {{ dateTimeFormat($reservation->created_at) }}
                                                    </div>
                                                </div> 
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12 col-md-12">
                                                            <input name="pickup_date" id="pickup_date" wire:model="pickup_date" class="form-control date-picker @error('pickup_date') is-invalid @enderror" type="text" value="{{ dateFormat($reservation->pickup_date) }}"required>
                                                            @error('pickup_date')
