                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                            ...
                                                            <tbody>
                                                                @foreach ($accommodations as $no=>$acc)
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <p>{{ $acc->servicename." ".$acc->location." ".dateFormat($acc->checkin)." - ".dateFormat($acc->checkout)." ".$acc->subservice }}</p>
                                                                        </td>
                                                                        <td class="text-right">
                                                                            <p>{{ "$ ". number_format(($acc->final_price / $acc->duration)/$acc->number_of_room, 2, ".", ",") }}</p>
                                                                        </td>
                                                                        <td class="text-right">
                                                                        ...
                                                                        <td class="text-right">
                                                                            <p>{{ "$ ". number_format($acc->final_price, 2, ".", ",") }}</p>
                                                                        </td>
                                                                        @if ($reservation->status != "Active")
                                                                            <td></td>
                                                                        @endif
                                                                ...
                                                                @foreach ($tours as $tour)
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <p>{{ $tour->service." ".$tour->subservice." ".dateFormat($tour->checkin)." - ".dateFormat($tour->checkout) }}</p>
                                                                        </td>
                                                                        <td class="text-right">
                                                                            <p>{{ "$ ". number_format($tour->price_pax, 2, ".", ",") }}</p>
                                                                        </td>
                                                                        <td class="text-right">
                                                                        ...
                                                                        <td class="text-right">
                                                                            <p>{{ "$ ". number_format($tour->final_price, 2, ".", ",") }}</p>
                                                                        </td>
                                                                        @if ($reservation->status != "Active")
                                                                            <td></td>
                                                                        @endif
                                                                ...
                                                                @foreach ($activities as $activity)
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <p>{{ $activity->service." ".$activity->location." ".dateFormat($activity->checkin)." ".$activity->subservice }}</p>
                                                                        </td>
                                                                        <td class="text-right">
                                                                            <p>{{ "$ ". number_format($activity->price_pax, 2, ".", ",") }}</p>
                                                                        </td>
                                                                        <td class="text-right">
                                                                        ...
                                                                        <td class="text-right">
                                                                            <p>{{ "$ ". number_format($activity->final_price, 2, ".", ",") }}</p>
                                                                        </td>
                                                                        @if ($reservation->status != "Active")
                                                                            <td></td>
                                                                        @endif
                                                                ...
                                                                @foreach ($transports as $transport)
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <p>{{ $transport->service." ".$transport->service_type." ".dateFormat($transport->checkin)." ".$transport->servicename." ".$transport->capacity." Seat" }}</p>
                                                                        </td>
                                                                        <td class="text-right">
                                                                            <p>{{ "$ ". number_format($transport->price_pax, 2, ".", ",") }}</p>
                                                                        </td>
                                                                        <td class="text-right">
                                                                            <p>1</p>
                                                                        </td>
                                                                        ...
                                                                        <td class="text-right">
                                                                            <p>{{ "$ ". number_format($transport->final_price, 2, ".", ",") }}</p>
                                                                        </td>
                                                                        @if ($reservation->status != "Active")
                                                                            <td></td>
                                                                        @endif
                                                                ...
                                                                @foreach ($additional_invoice as $additionalinv)
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-right">
                                                                            <p>{{ "$ ". number_format($additionalinv->rate, 2, ".", ",") }}</p>
                                                                        </td>
                                                                        <td class="text-right">
                                                                        ...
                                                                        <td class="text-right">
                                                                            <p>{{ "$ ". number_format($additionalinv->amount, 2, ".", ",") }}</p>
                                                                        </td>
                                                                        @if ($reservation->status != "Active")
                                                                            <td>
                                                                                <div class="reservation-guest">
                                                                                    <span>
                                                                                        <a href="modal" data-toggle="modal" data-target="#edit-additional-inv-{{ $additionalinv->id }}"> 
                                                                                            ...
                                                                                            <div class="col-sm-4">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <select name="date" class="form-control @error('date') is-invalid @enderror" placeholder="Select date" required>
                                                                                                        <option selected value="{{ dateFormat($additionalinv->date) }}">{{ dateFormat($additionalinv->date) }}</option>
                                                       ...
                                                       {{-- {{ "Total Price: $". number_format($total_price_order, 2, ".", ",") }} --}}
                                                    </div>
                                                    @if ($reservation->status != "Active")
                                                        <div class="col-md-12 text-right"> 
                                                            <a href="modal" data-toggle="modal" data-target="#add-additional-inv"> 
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-3 col-md-2">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-12 text-right det-list">{{ number_format($total_price_order+$sum_additional_invoice, 2, ".", ",") }}</div>
                                                                    <div class="col-md-12 text-right det-list">0.00</div>
                                                                    <div class="col-md-12 text-right det-list">0.00</div>
                                                                    <div class="col-md-12 text-right det-list">0.00</div>
                                                                    <div class="col-md-12 text-right det-list">{{ number_format($total_price_order+$sum_additional_invoice, 2, ".", ",") }}</div>
                                                    ...
                                                    @if (isset($bankaccount))
                                                        <div class="row">
                                                            ...
                                                            <div class="btn-edit-modal m-r-18">
                                                                @if ($reservation->status != "Active")
                                                                    <a href="modal" data-toggle="modal" data-target="#edit-bank-{{ $invoice->id }}"> 
                                                                        <button class="btn-view"><i class="icon-copy fa fa-pencil" aria-hidden="true"></i></button>
                                                                    </a>
                                                                @endif
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <div class="col-sm-12">
                                                                                                    <select name="bank_id" class="form-control @error('bank_id') is-invalid @enderror" placeholder="Select bank account" required>
