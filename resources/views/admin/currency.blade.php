                                ...
                                <div class="card-box m-b-18">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-12 col-sm-12 text-right">
                                            <p><i>last updated : {{ dateTimeFormat($usdrates->updated_at) }}</i></p>
                                        </div>
                                        @canany(['posDev','posAuthor'])
                                            <div class="edit-button">
                                                <a href="modal" data-toggle="modal" data-target="#edit-usdrates-{{ $usdrates->id }}">
                            ...
                            <div class="col-md-12">
                                <div class="card-box m-b-18">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-12 col-sm-12 text-right">
                                            <p><i>last updated : {{ dateTimeFormat($cnyrates->updated_at) }}</i></p>
                                        </div>
                                        @canany(['posDev','posAuthor'])
                                            <div class="edit-button">
                                                <a href="modal" data-toggle="modal" data-target="#edit-cnyrates-{{ $cnyrates->id }}">
                                                    <button class="btn edit-btn" data-toggle="tooltip" data-placement="top" title="Update usd rate"><i class="icon-copy fa fa-pencil" aria-hidden="true"></i></button>
                                                </a>
                                            </div>
                                            {{-- MODAL EDIT CNY RATE --}}
                            ...
                            <div class="col-md-12">
                                <div class="card-box m-b-18">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-12 col-sm-12 text-right">
                                            <p><i>last updated : {{ dateTimeFormat($twdrates->updated_at) }}</i></p>
                                        </div>
                                        @canany(['posDev','posAuthor'])
                                            <div class="edit-button">
                                                <a href="modal" data-toggle="modal" data-target="#edit-twdrates-{{ $twdrates->id }}">
                        ...
                        <div class="card-box m-b-18">
                            ...
                            <div class="row">
                                <div class="col-9 col-md-8 col-sm-8">
                                    ...
                                    <p>last updated : {{ dateTimeFormat($tax->updated_at) }}</p>
                                </div>
                                @canany(['posDev','posAuthor'])
                                    <div class="edit-button">
                                        <a href="modal" data-toggle="modal" data-target="#edit-tax-{{ $tax->id }}">
                    ...
                    <div class="col-md-4">
                        <div class="card-box m-b-18">
                            ...
                            <div class="row">
                                @canany(['posDev','posAuthor'])
                                    <div class="edit-button">
                                        <a href="modal" data-toggle="modal" data-target="#add-bank-account">
                                        ...
                                        <div class="position-relatif">
                                            ...
                                            @canany(['posDev','posAuthor'])
                                                <div class="btn-container">
                                                    <a href="modal" data-toggle="modal" data-target="#edit-bank-account-{{ $perbankan->id }}">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-6">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <select name="currency" id="currency"  type="text" class="form-control @error('currency') is-invalid @enderror" placeholder="Select currency" required>
