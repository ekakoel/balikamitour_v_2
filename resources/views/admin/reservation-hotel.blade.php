                                    ...
                                    <div class="col-md-12">
                                        <div class="input-group row">
                                            <div class="col-md-4 p-b-8">
                                                ...
                                                <input id="searchHotelName" type="text" onkeyup="searchTable('searchHotelName','tbord',1)" class="form-control" name="search-byno" placeholder="Sort by hotel name">
                                            </div>
                                        </div>
                                        @if (count($hotels) > 0)
                                            ...
                                            <tbody>
                                                @foreach ($hotels as $no=>$hotel)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <a href="modal" data-toggle="modal" data-target="#add-hotel-{{ $hotel->id }}"> 
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-sm-3">
                                                                                            <div class="form-group row">
                                                                                                ...
                                                                                                <div class="col-sm-12">
                                                                                                    <select name="servicename" class="form-control @error('servicename') is-invalid @enderror" required>
                                                                                        ...
                                                                                        <div class="col-sm-3">
                                                                                            <div class="form-group row">
                                                                                                ...
                                                                                                <div class="col-sm-12">
                                                                                                    <select name="extra_bed" class="form-control @error('extra_bed') is-invalid @enderror" value="{{ old('extra_bed') }}">
                                                                                        ...
                                                                                        <div class="col-sm-3">
                                                                                            <div class="form-group row">
                                                                                                ...
                                                                                                <div class="col-sm-12">
                                                                                                    <select name="guest_1" class="form-control @error('guest_1') is-invalid @enderror" required>
                                                                                        ...
                                                                                        <div class="col-sm-3">
                                                                                            <div class="form-group row">
                                                                                                ...
                                                                                                <div class="col-sm-12">
                                                                                                    <select name="guest_2" class="form-control @error('guest_2') is-invalid @enderror">
                                                                                                        <option selected value="">Select Guest</option>
                                                                                                        @foreach ($guests as $guest)
                                                                                                            <option value="{{ $guest->id }}">{{ $guest->name }}</option>
                                                                                                        @endforeach
                                                                                        ...
                                                                                        <div class="col-sm-3">
                                                                                            <div class="form-group row">
                                                                                                ...
                                                                                                <div class="col-sm-12">
                                                                                                    <select name="guest_3" class="form-control @error('guest_3') is-invalid @enderror">
                                                                                                        <option selected value="">Select Guest</option>
                                                                                                        @foreach ($guests as $guest)
                                                                                                            <option value="{{ $guest->id }}">{{ $guest->name }}</option>
                                                                                                        @endforeach
                                                                                        ...
                                                                                        <div class="col-sm-3">
                                                                                            <div class="form-group row">
                                                                                                ...
                                                                                                <div class="col-sm-12">
                                                                                                    <select name="guest_4" class="form-control @error('guest_4') is-invalid @enderror">
                                                                                                        <option selected value="">Select Guest</option>
                                                                                                        @foreach ($guests as $guest)
                                                                                                            <option value="{{ $guest->id }}">{{ $guest->name }}</option>
                                                                                                        @endforeach
