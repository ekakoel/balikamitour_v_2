                                                ...
                                                @if ($order->status == "Pending")
                                                    <span>
                                                        @if ($wedding_order->wedding_venue_id !== "null" and $wedding_order->wedding_venue_id)
                                                            <a href="modal" data-toggle="modal" data-target="#add-wedding-venue"> 
                                            ...
                                            @foreach ($wed_venues_id as $wed_venue_id)
                                                <div class="col-md-6 m-b-8">
                                                    ...
                                                    @if ($wedding_venue)
                                                        ...
                                                        @endphp
                                                        <div class="card">
                                                            <a href="modal" data-toggle="modal" data-target="#detail-wedding_venue-{{ $wed_venue_id }}">
                                                ...
                                                @if ($order->status == "Pending")
                                                    <span>
                                                        @if ($wedding_order->wedding_room_id !== "null" and $wedding_order->wedding_room_id)
                                                            <a href="modal" data-toggle="modal" data-target="#add-wedding-room"> 
                                        ...
                                        @if ($rooms_id != "null" and $rooms_id )
                                            @foreach ($rooms_id as $roomsid)
                                                ...
                                                @if ($rooms)
                                                    ...
                                                    <div class="col-md-6 m-b-8">
                                                        <div class="card">
                                                            <a href="modal" data-toggle="modal" data-target="#detail-rooms-{{ $roomsid }}">
                                                                <div class="card-image-container">
                                                ...
                                                @if ($order->status == "Pending")
                                                    <span>
                                                        @if ($wedding_order->wedding_makeup_id !== "null" and $wedding_order->wedding_makeup_id)
                                                            <a href="modal" data-toggle="modal" data-target="#add-wedding-makeup"> 
                                            ...
                                            @foreach ($wed_makeups_id as $wed_makeup_id)
                                                <div class="col-md-6 m-b-8">
                                                    ...
                                                    @if ($wedding_makeup)
                                                        ...
                                                        @endphp
                                                        <div class="card">
                                                            <a href="modal" data-toggle="modal" data-target="#detail-wedding_makeup-{{ $wed_makeup_id }}">
                                                                <div class="card-image-container">
                                                ...
                                                @if ($order->status == "Pending")
                                                    <span>
                                                        @if ($wedding_order->wedding_decoration_id !== "null" and $wedding_order->wedding_decoration_id)
                                                            <a href="modal" data-toggle="modal" data-target="#add-wedding-decoration"> 
                                            ...
                                            @foreach ($wed_decorations_id as $wed_decoration_id)
                                                <div class="col-md-6 m-b-8">
                                                    ...
                                                    @if ($wedding_decoration)
                                                        ...
                                                        @endphp
                                                        <div class="card">
                                                            <a href="modal" data-toggle="modal" data-target="#detail-wedding_decoration-{{ $wed_decoration_id }}">
                                                                <div class="card-image-container">
                                                ...
                                                @if ($order->status == "Pending")
                                                    <span>
                                                        @if ($wedding_order->wedding_dinner_venue_id !== "null" and $wedding_order->wedding_dinner_venue_id)
                                                            <a href="modal" data-toggle="modal" data-target="#add-wedding-dinner_venue"> 
                                                                <i class="icon-copy  fa fa-pencil" data-toggle="tooltip" data-placement="top" title="Edit Wedding Decoration" aria-hidden="true"></i>
                                                            </a>
                                                        @else
                                                            <a href="modal" data-toggle="modal" data-target="#add-wedding-dinner_venue"> 
                                            ...
                                            @foreach ($wed_dinner_venues_id as $wed_dinner_venue_id)
                                                <div class="col-md-6 m-b-8">
                                                    ...
                                                    @if ($wedding_dinner_venue)
                                                        ...
                                                        @endphp
                                                        <div class="card">
                                                            <a href="modal" data-toggle="modal" data-target="#detail-wedding_dinner_venue-{{ $wed_dinner_venue_id }}">
                                                                <div class="card-image-container">
                                                ...
                                                @if ($order->status == "Pending")
                                                    <span>
                                                        @if ($wedding_order->wedding_entertainment_id !== "null" and $wedding_order->wedding_entertainment_id)
                                                            <a href="modal" data-toggle="modal" data-target="#add-wedding-entertainment"> 
                                            ...
                                            @foreach ($wed_entertainments_id as $wed_entertainment_id)
                                                <div class="col-md-6 m-b-8">
                                                    ...
                                                    @if ($wedding_entertainment)
                                                        ...
                                                        @endphp
                                                        <div class="card">
                                                            <a href="modal" data-toggle="modal" data-target="#detail-wedding-entertainment-{{ $wed_entertainment_id }}">
                                                                <div class="card-image-container">
                                                ...
                                                @if ($order->status == "Pending")
                                                    <span>
                                                        @if ($wedding_order->wedding_documentation_id !== "null" and $wedding_order->wedding_documentation_id)
                                                            <a href="modal" data-toggle="modal" data-target="#add-wedding-documentation"> 
                                            ...
                                            @foreach ($wed_documentations_id as $wed_documentation_id)
                                                <div class="col-md-6 m-b-8">
                                                    ...
                                                    @if ($wedding_documentation)
                                                        ...
                                                        @endphp
                                                        <div class="card">
                                                            <a href="modal" data-toggle="modal" data-target="#detail-wedding_documentation-{{ $wed_documentation_id }}">
                                                                <div class="card-image-container">
                                                ...
                                                @if ($order->status == "Pending")
                                                    <span>
                                                        @if ($wedding_order->wedding_transport_id !== "null" and $wedding_order->wedding_transport_id)
                                                            <a href="modal" data-toggle="modal" data-target="#add-wedding-transport"> 
                                            ...
                                            @foreach ($wed_transports_id as $wed_transport_id)
                                                <div class="col-md-6 m-b-8">
                                                    ...
                                                    @if ($weddingTransport)
                                                        ...
                                                        @endphp
                                                        <div class="card">
                                                            <a href="modal" data-toggle="modal" data-target="#detail-wedding-transport-{{ $wed_transport_id }}">
                                                                <div class="card-image-container">
                                                ...
                                                @if ($order->status == "Pending")
                                                    <span>
                                                        @if ($wedding_order->wedding_other_id !== "null" and $wedding_order->wedding_other_id)
                                                            <a href="modal" data-toggle="modal" data-target="#add-wedding-other"> 
                                                                <i class="icon-copy  fa fa-pencil" data-toggle="tooltip" data-placement="top" title="Edit Wedding Entertainment" aria-hidden="true"></i>
                                                            </a>
                                                        @else
                                                            <a href="modal" data-toggle="modal" data-target="#add-wedding-other"> 
                                            ...
                                            @foreach ($wed_others_id as $wed_other_id)
                                                <div class="col-md-6 m-b-8">
                                                    ...
                                                    @if ($wedding_other)
                                                        ...
                                                        @endphp
                                                        <div class="card">
                                                            <a href="modal" data-toggle="modal" data-target="#detail-wedding-other-{{ $wed_other_id }}">
                                                                <div class="card-image-container">
