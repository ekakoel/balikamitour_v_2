                                ...
                                <div class="card-box">
                                    ...
                                    @canany(['posDev','weddingDvl','weddingAuthor'])
                                        <div class="card-box-footer">
                                            <a href="modal" data-toggle="modal" data-target="#edit-vendor"><button class="btn btn-primary"><i class="fa fa-pencil"></i> Edit Vendor</button></a>
                                        </div>
                                        {{-- MODAL EDIT VENDOR --------------------------------------------------------------------------------------------------------------- --}}
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="card-box">
                                        ...
                                        @canany(['posDev','weddingDvl','weddingAuthor'])
                                            <div class="card-box-footer">
                                                <a href="modal" data-toggle="modal" data-target="#add-package"><button class="btn btn-primary"><i class="ion-plus-round"></i> Add Service</button></a>
                                            </div>
                                            {{-- MODAL ADD SERVICES --------------------------------------------------------------------------------------------------------------- --}}
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-12 col-sm-6 col-md-6">
                                                                            <div class="form-group ">
                                                                                ...
                                                                                <select id="typeService" name="type" type="text" class="form-control @error('type') is-invalid @enderror" placeholder="Select type" required>
                                                                        ...
                                                                        <div class="col-6 col-sm-3 col-md-3">
                                                                            <div class="form-group ">
                                                                                ...
                                                                                <select name="time" id="time"  type="text" class="form-control @error('type') is-invalid @enderror" placeholder="Select time">
