                ...
                <div class="col-md-8">
                    <div class="card-box">
                        <div class="card-box-title">
                            ...
                            <span>
                                <a href="modal" data-toggle="modal" data-target="#add-accommodation-to-order-wedding-{{ $orderWedding->id }}"> 
                        ...
                        <table class="data-table table nowrap dataTable no-footer dtr-inline">
                            ...
                            <tbody>
                                ...
                                @if ($orderWedding->service == "Wedding Package")
                                    <tr>
                                        <td class="pd-2-8">
                                            {{ dateFormat($orderWedding->checkin) }} - {{ dateFormat($orderWedding->checkout) }} <br>
                                ...
                                @foreach ($accommodationInvs as $no_acc=>$accommodation_inv)
                                    ...
                                    <tr class="{{ $accommodation_inv->public_rate<=0?"bg-notif":""; }} {{ $accommodation_inv_duration<=0?"bg-notif":""; }}">
                                        <td class="pd-2-8">
                                            {{ dateFormat($accommodation_inv->checkin) }} - {{ dateFormat($accommodation_inv->checkout) }}<br>
                                        ...
                                        <td class="text-right pd-2-8">
                                            <div class="table-action">
                                                <span>
                                                    <a href="modal" data-toggle="modal" data-target="#updatePriceAccommodation-{{ $accommodation_inv->id }}">
                                                        <i class="icon-copy fa fa-dollar" data-toggle="tooltip" title="Change Status and Price" aria-hidden="true"></i>
                                                    </a>
                                                    
                                                </span>
                                                <span>
                                                    <a href="modal" data-toggle="modal" data-target="#edit-wedding-order-accommodation-invitation-{{ $accommodation_inv->id }}">
                        ...
                        <div class="box-price-kicked">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-sm-4 text-right">
                                    <div class="promo-text">
                                        {{ "$ ".number_format($extra_bed_total_price,0,',','.') }}
                                    </div>
                                </div>
                                <div class="col-6 col-sm-8 text-right">
                                    <div class="promo-text">
                                ...
                                <div class="col-6 col-sm-4 text-right">
                                    ...
                                    @else
                                        <b>
                                            {{ "$ ".number_format($grand_total_accommodation_price,0,',','.') }}
                                        </b>
                                    @endif
                                </div>
                            </div>
