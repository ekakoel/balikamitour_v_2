                                ...
                                <div class="order-status-container">
                                    ...
                                    @elseif ($orderWedding->status == "Approved" or $orderWedding->status == "Paid")
                                        ...
                                        @if ($reservation->checkin > $now)
                                            - <div class="standby-order"><p><i class="icon-copy ion-clock"> </i> {{ dateFormat($orderWedding->checkin) }}</p></div>
                                    ...
                                    @elseif($orderWedding->status == "Paid")
                                        <div class="status-paid-color"><i class="icon-copy fa fa-check-circle" aria-hidden="true"></i> {{ $orderWedding->status }} ({{ dateFormat($orderWedding->updated_at) }})</div>
                                    @else
                            ...
                            <div class="card-box">
                                ...
                                @if ($orderWedding->status !== "Paid")
                                    <div class="card-box-footer">
                                        <a href="modal" data-toggle="modal" data-target="#add-order-note"><button type="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> @lang('messages.Add Note')</button></a>
                                    </div>
                                @endif
                            </div>
                            {{-- MODAL ORDER NOTE --}}
                                ...
                                <div class="col-md-12">
                                    <div class="card-box">
                                        <div class="card-box-title">
                                            ...
                                            <span>{{ dateFormat($invoice->inv_date) }}</span>
                                        </div> 
                                ...
                                <div class="col-md-12">
                                    <div class="card-box">
                                        <div class="card-box-title">
                                            ...
                                            @if ($invoice->balance > 0)
                                                <span>
                                                    <a href="modal" data-toggle="modal" data-target="#mobile-admin-add-receipt-wedding-{{ $orderWedding->id }}">
                                        ...
                                        @foreach ($receipts as $receipt)
                                            <a class="card-link" href="modal" data-toggle="modal" data-target="#mobile-receipt-{{ $receipt->id }}">
                                                <div class="card-ptext-margin">
                                                    ...
                                                    @if ($receipt->status != "Valid")
                                                        <div class="view-receipt">
                                                            <a href="modal" data-toggle="modal" data-target="#mobile-receipt-{{ $receipt->id }}">
                                    ...
                                    <div class="card-box">
                                        ...
                                        <div class="pmt-des">
                                            <div class="card-ptext-content">
                                                ...
                                                <div class="ptext-title">@lang('messages.Payment deatline')</div>
                                                <div class="ptext-value">{{ dateFormat($invoice->due_date) }}</div>
                                                @if ($invoice->currency->name == 'USD')
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="card-ptext-content">
                                                                            ...
                                                                            <div class="ptext-value">{{ dateTimeFormat($orderWedding->handled_date) }}</div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6 text-right">
                                                    <div class="description author">
                                                        ...
                                                        <i>{{ dateTimeFormat($orderWedding->handled_date) }}</i>
                                                    </div>
                                                </div>
                                            </div>
                                        @endif
                            ...
                            <div class="row">
                                    ...
                                    <div class="page-subtitle">
                                        ...
                                        @if ($orderWedding->status == "Pending")
                                            @if ($orderWedding->handled_by)
                                                @if ($orderWedding->handled_by == Auth::user()->id)
                                                    <span>
                                                        <a href="modal" data-toggle="modal" data-target="#edit-wedding-bride-{{ $bride->id }}"> 
                                            ...
                                            <table class="data-table table stripe nowrap no-footer dtr-inline" >
                                                ...
                                                <tbody>
                                                    @foreach ($flights as $flight)
                                                        <tr>
                                                            <td class="pd-2-8">{{ dateTimeFormat($flight->time) }}</td>
                                            ...
                                            @if ($orderWedding->status != "Approved")
                                                @if ($orderWedding->status != "Paid")
                                                    @if ($orderWedding->handled_by)
                                                        @if ($orderWedding->handled_by == Auth::user()->id)
                                                            <span>
                                                                <a href="modal" data-toggle="modal" data-target="#add-flight-order-wedding-{{ $orderWedding->id }}"> 
                                                                    ...
                                                                    @if ($orderWedding->handled_by)
                                                                        @if ($orderWedding->handled_by == Auth::user()->id)
                                                                            <div class="table-action">
                                                                                <a href="modal" data-toggle="modal" data-target="#update-wedding-flight-{{ $flight->id }}"> 
                                                                                            ...
                                                                                            <div class="row">
                                                                                                ...
                                                                                                <div class="col-sm-6">
                                                                                                    <div class="form-group">
                                                                                                        ...
                                                                                                        <select name="group" class="custom-select col-12 @error('group') is-invalid @enderror" required>
                                                                                                ...
                                                                                                <div class="col-sm-6">
                                                                                                    <div class="form-group">
                                                                                                        ...
                                                                                                        <input type="text" readonly name="time" class="form-control datetimepicker @error('time') is-invalid @enderror"  placeholder="@lang('messages.Select date and time')" value="{{ dateTimeFormat($flight->time) }}" required>
                                                                                                        @error('time')
                                                                                                            <span class="invalid-feedback">
                                                                                                                {{ $message }}
                                                                                                            </span>
                                            ...
                                            @if ($orderWedding->status != "Approved")
                                                @if ($orderWedding->status != "Paid")
                                                    @if ($orderWedding->handled_by)
                                                        @if ($orderWedding->handled_by == Auth::user()->id)
                                                            <span>
                                                                <a href="modal" data-toggle="modal" data-target="#add-invitation-order-wedding-{{ $orderWedding->id }}"> 
                                                                    <i class="icon-copy  fa fa-plus-circle" data-toggle="tooltip" data-placement="top" title="@lang('messages.Add')" aria-hidden="true"></i>
                                                                </a>
                                                            </span>
                                                        @endif
                                                            ...
                                                            <div class="table-action">
                                                                @if ($orderWedding->status != "Approved")
                                                                    @if ($orderWedding->status != "Paid")
                                                                        @if ($orderWedding->handled_by)
                                                                            @if ($orderWedding->handled_by == Auth::user()->id)
                                                                                <a href="modal" data-toggle="modal" data-target="#detail-invitation-{{ $guest->id }}"> 
                                                                                    <i class="icon-copy  fa fa-eye" data-toggle="tooltip" data-placement="top" title="@lang('messages.Detail')" aria-hidden="true"></i>
                                                                                </a>
                                                                                <a href="modal" data-toggle="modal" data-target="#update-invitation-{{ $guest->id }}"> 
                                                                                    <i class="icon-copy  fa fa-pencil" data-toggle="tooltip" data-placement="top" title="@lang('messages.Edit')" aria-hidden="true"></i>
                                                                                </a>
                                    ...
                                    <div class="page-subtitle">
                                        ...
                                        @if ($orderWedding->status == "Pending")
                                            @if ($orderWedding->handled_by)
                                                @if ($orderWedding->handled_by == Auth::user()->id)
                                                    <span>
                                                        <a href="modal" data-toggle="modal" data-target="#update-wedding-order-wedding-{{ $orderWedding->id }}">
                                    ...
                                    @if ($orderWedding->reception_date_start && $orderWedding->service == "Reception Venue")
                                        <div class="card-ptext-margin">
                                            <div class="card-ptext-content">
                                                ...
                                                <div class="ptext-value">
                                                    {{ dateTimeFormat($orderWedding->reception_date_start) }} - (22:00)
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="btn-icon">
                                                                                ...
                                                                                <input readonly name="wedding_date" type="text" id="wedding_date" class="form-control input-icon date-picker @error('wedding_date') is-invalid @enderror" type="text" value="{{ dateFormat($orderWedding->wedding_date) }}" required>
                                                                            </div>
                                                                            @error('wedding_date')
                                                                                <span class="invalid-feedback">
                                                                                    <strong>{{ $message }}</strong>
                                                                ...
                                                                @elseif ($orderWedding->service == "Reception Venue")
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="btn-icon">
                                                                                <span><i class="icon-copy fi-calendar"></i></span>
                                                                                <input readonly name="reception_date_start" type="text" id="reception_date_start" class="form-control input-icon date-picker @error('reception_date_start') is-invalid @enderror" type="text" value="{{ dateFormat($orderWedding->reception_date_start) }}" required>
                                                                            </div>
                                                                ...
                                                                @elseif ($orderWedding->service == "Wedding Package")
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="btn-icon">
                                                                                <span><i class="icon-copy fi-calendar"></i></span>
                                                                                <input readonly name="wedding_date" type="text" id="wedding_date" class="form-control input-icon date-picker @error('wedding_date') is-invalid @enderror" value="{{ dateFormat($orderWedding->wedding_date) }}" required>
                                                                            </div>
                                                                            @error('wedding_date')
                                                                                <span class="invalid-feedback">
                                                                                    <strong>{{ $message }}</strong>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="btn-icon">
                                                                                <span><i class="icon-copy fi-calendar"></i></span>
                                                                                <input readonly name="reception_date_start" type="text" id="reception_date_start" class="form-control input-icon datetimepicker @error('reception_date_start') is-invalid @enderror" value="{{ dateTimeFormat($orderWedding->reception_date_start)) }}" required>
                                                                            </div>
                                                                            @error('reception_date_start')
                                                                                <span class="invalid-feedback">
                                                                                    <strong>{{ $message }}</strong>
                                ...
                                <div id="weddingVenue" class="col-md-6">
                                    <div class="page-subtitle">
                                        ...
                                        <span>
                                            <a href="modal" data-toggle="modal" data-target="#detail-wedding-venue-{{ $hotel->id }}"> 
                                                <i class="icon-copy  fa fa-eye" data-toggle="tooltip" data-placement="top" title="@lang('messages.Detail')" aria-hidden="true"></i>
                                            </a>
                                        </span>
                                    </div>
                                    ...
                                    <div class="modal fade" id="detail-wedding-venue-{{ $hotel->id }}" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content text-left">
                                                <div class="card-box">
                                                    <div class="card-box-title">
                                                        <div class="subtitle"><i class="icon-copy fa fa-building"></i>@lang('messages.Wedding Venue')</div>
                                                    </div>
                                                    <div class="card-banner">
                                ...
                                @if ($orderWedding->status == "Pending")
                                    <div id="ceremonyVenue" class="col-md-6">
                                        <div class="page-subtitle {{ $ceremonyVenue?"":"empty-value" }}">
                                                ...
                                                @if ($orderWedding->handled_by == Auth::user()->id)
                                                    @if ($ceremonyVenue)
                                                            ...
                                                            @if ($orderWedding->service != "Wedding Package")
                                                                @if ($orderWedding->service != "Ceremony Venue")
                                                                    <span>
                                                                        <form action="/admin-fdelete-wedding-order-ceremony-venue/{{ $orderWedding->id }}" method="post" enctype="multipart/form-data">
                                                                            @csrf
                                                                            @method('put')
                                                                ...
                                                                @endif
                                                                <span>
                                                                    <a href="modal" data-toggle="modal" data-target="#update-wedding-order-ceremony-venue-{{ $orderWedding->id }}"> 
                                            ...
                                            @if ($ceremonyVenue)
                                                <span>
                                                    <a href="modal" data-toggle="modal" data-target="#detail-ceremony-venue-{{ $ceremonyVenue->id }}"> 
                                                        <i class="icon-copy  fa fa-eye" data-toggle="tooltip" data-placement="top" title="@lang('messages.Detail')" aria-hidden="true"></i>
                                                    </a>
                                                </span>
                                            @endif
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select name="slot" id="slot" class="form-control @error('slot') is-invalid @enderror" required>
                                                ...
                                                @if ($orderWedding->ceremony_venue_decoration_id)
                                                    @if ($orderWedding->handled_by)
                                                        @if ($orderWedding->handled_by == $admin->id)
                                                            @if ($orderWedding->service != "Wedding Package")
                                                                <span>
                                                                    <form action="/admin-fdelete-wedding-order-decoration-ceremony-venue/{{ $orderWedding->id }}" method="post" enctype="multipart/form-data">
                                                                        @csrf
                                                                        @method('put')
                                                                        <button class="icon-btn-remove" onclick="return confirm('Are you sure?');" type="submit" data-toggle="tooltip" data-placement="top" title="Remove"><i class="icon-copy fa fa-trash"></i></button>
                                                                    </form>
                                                                ...
                                                                <span>
                                                                    <a href="modal" data-toggle="modal" data-target="#update-decoration-ceremony-venue-{{ $orderWedding->id }}"> 
                                                                        <i class="icon-copy  fa fa-pencil" data-toggle="tooltip" data-placement="top" title="@lang('messages.Change')" aria-hidden="true"></i>
                                                                    </a>
                                                                </span>
                                                            @endif
                                                    ...
                                                    @endif
                                                    <span>
                                                        <a href="modal" data-toggle="modal" data-target="#detail-decoration-ceremony-venue-{{ $ceremonyVenueDecoration->id }}"> 
                                                            <i class="icon-copy  fa fa-eye" data-toggle="tooltip" data-placement="top" title="@lang('messages.Detail')" aria-hidden="true"></i>
                                                        </a>
                                                    </span>
                                                @else
                                    ...
                                    @if ($receptionVenue)
                                        <div id="orderWeddingReceptionVenue" class="col-md-6">
                                            <div class="page-subtitle" {{ $receptionVenue?"":"empty-value" }}>
                                                ...
                                                <span>
                                                    <a href="modal" data-toggle="modal" data-target="#detail-reception-venue-{{ $receptionVenue->id }}"> 
                                                        <i class="icon-copy  fa fa-eye" data-toggle="tooltip" data-placement="top" title="@lang('messages.Detail')" aria-hidden="true"></i>
                                                    </a>
                                                </span>
                                            </div>
                                                    ...
                                                    @if ($orderWedding->status == "Pending")
                                                        @if ($orderWedding->handled_by)
                                                            @if ($orderWedding->handled_by == Auth::user()->id)
                                                                ...
                                                                @endif
                                                                <span>
                                                                    <a href="modal" data-toggle="modal" data-target="#update-reception-venue-{{ $orderWedding->id }}"> 
                                                                        <i class="icon-copy  fa fa-pencil" data-toggle="tooltip" data-placement="top" title="@lang('messages.Change')" aria-hidden="true"></i>
                                                                    </a>
                                                                </span>
                                                            @endif
                                        ...
                                        <div id="orderWeddingDecorationReceptionVenue" class="col-md-6">
                                            <div class="page-subtitle">
                                                ...
                                                @if ($orderWedding->reception_venue_decoration_id)
                                                    <span>
                                                        <a href="modal" data-toggle="modal" data-target="#detail-decoration-reception-venue-{{ $decorationReceptionVenue->id }}"> 
                                                            <i class="icon-copy  fa fa-eye" data-toggle="tooltip" data-placement="top" title="@lang('messages.Detail')" aria-hidden="true"></i>
                                                        </a>
                                                    </span>
                                                @endif
                                                        ...
                                                        @if ($orderWedding->status != "Paid")
                                                            @if ($orderWedding->handled_by == Auth::user()->id)
                                                                @if ($orderWedding->service != "Wedding Package")
                                                                    ...
                                                                    <span>
                                                                        <a href="modal" data-toggle="modal" data-target="#update-decoration-reception-venue-{{ $orderWedding->id }}"> 
                                                                            <i class="icon-copy  fa fa-pencil" data-toggle="tooltip" data-placement="top" title="@lang('messages.Change')" aria-hidden="true"></i>
                                                                        </a>
                                                                    </span>
                                                                @endif
                                            ...
                                            <table class="data-table table stripe nowrap no-footer dtr-inline" >
                                                ...
                                                <tbody>
                                                    ...
                                                    @if ($transport_bride_id)
                                                            ...
                                                            @if ($bride_transport)
                                                                <tr>
                                                                    <td class="pd-2-8">{{ dateFormat($orderWedding->checkin) }}</td>
                                                                    <td class="pd-2-8">Airport Shuttle (Arrival), {{ $bride_transport->brand }} - {{ $bride_transport->name }}</td>
                                                                    <td class="pd-2-8"><i>Include</i></td>
                                                                    <td class="pd-2-8 text-right">
                                                                        <a href="modal" data-toggle="modal" data-target="#detail-transport_bride-service-{{ $bride_transport->id }}"> 
                                                                            <i class="icon-copy  fa fa-eye" data-toggle="tooltip" data-placement="top" title="@lang('messages.Detail')" aria-hidden="true"></i>
                                                                        </a>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="pd-2-8">{{ dateFormat($orderWedding->checkout) }}</td>
                                                    ...
                                                    @if ($transportInvitations)
                                                        @foreach ($transportInvitations as $transport_invitation)
                                                            <tr class="{{ $transport_invitation->price <= 0?"bg-notif":""; }}">
                                                                <td class="pd-2-8">{{ dateTimeFormat($transport_invitation->date) }}</td>
                                                                ...
                                                                <td class="pd-2-8 text-right">
                                                                    @if ($orderWedding->handled_by)
                                                                        @if ($orderWedding->handled_by == Auth::user()->id)
                                                                            @if ($orderWedding->status != "Approved")
                                                                                @if ($orderWedding->status != "Paid")
                                                                                    <span>
                                                                                        <a href="modal" data-toggle="modal" data-target="#update-transport-invitation-{{ $transport_invitation->id }}">
                                                                                            <i class="fa fa-pencil"></i>
                                                                                        </a>
                                                                                    </span>
                                                                                @endif
                                                                    ...
                                                                    @else
                                                                        ...
                                                                        @endif
                                                                    @endif
                                                                    <a href="modal" data-toggle="modal" data-target="#detail-transport_invitation-service-{{ $transport_invitation->id }}"> 
                                                                        <i class="icon-copy  fa fa-eye" data-toggle="tooltip" data-placement="top" title="@lang('messages.Detail')" aria-hidden="true"></i>
                                                                    </a>
                                                                </td>
                                                            </tr>
                                            ...
                                            @if ($orderWedding->handled_by)
                                                @if ($orderWedding->handled_by == $admin->id)
                                                    @if ($orderWedding->status != "Approved")
                                                        @if ($orderWedding->status != "Paid")
                                                            <span>
                                                                <a href="modal" data-toggle="modal" data-target="#add-order-wedding-transport-{{ $orderWedding->id }}">
                                                                    <i class="icon-copy  fa fa-plus-circle" data-toggle="tooltip" data-placement="top" title="@lang('messages.Add')" aria-hidden="true"></i>
                                                                </a>
                                                            </span>
                                                        @endif
                                                                        ...
                                                                        <div class="form-group ">
                                                                            ...
                                                                            <select name="date" class="form-control @error('date') is-invalid @enderror" value="{{ old('date') }}" required>
                                                                                ...
                                                                                @for ($wd = 0; $wd <= $orderWedding->duration; $wd++)
                                                                                    <option value="{{ dateFormat('+'.$wd .' days',strtotime($orderWedding->checkin)) }}">{{ dateFormat('+'.$wd .' days',strtotime($orderWedding->checkin)) }} 
                                                                                        {{ dateFormat($orderWedding->checkin) == dateFormat('+'.$wd .' days',strtotime($orderWedding->checkin)) ? "Check-in" : "" }}
                                                                                        {{ dateFormat($orderWedding->wedding_date) == dateFormat('+'.$wd .' days',strtotime($orderWedding->checkin)) ? "Wedding Ceremony" : "" }}
                                                                                        {{ dateFormat($orderWedding->checkout) == dateFormat('+'.$wd .' days',strtotime($orderWedding->checkin)) ? "Check-out" : "" }}
                                                                                    </option>
                                                                                @endfor
                                                                            </select>
                                                                            @error('date')
                                                                ...
                                                                @else
                                                                    <div class="col-md-6">
                                                                        <div class="form-group ">
                                                                            ...
                                                                            <select name="passenger" class="form-control @error('passenger') is-invalid @enderror" value="{{ old('passenger') }}" required>
                                                                                <option selected value="">@lang('messages.Select one')</option>
                                            ...
                                            <table class="data-table table stripe nowrap no-footer dtr-inline" >
                                                ...
                                                <tbody>
                                                    ...
                                                    @if ($orderWedding->room_bride_id)
                                                        <tr>
                                                            <td class="pd-2-8">{{ dateFormat($orderWedding->checkin) }} - {{ dateFormat($orderWedding->checkout) }}</td>
                                                            <td class="pd-2-8">{{ $orderWedding->hotel->name }} | {{ $orderWedding->suite_villa->rooms }} | Bride's</td>
                                                            <td class="pd-2-8">-</td>
                                                            <td class="pd-2-8"><i>Include</i></td>
                                                            <td class="pd-2-8 text-right">
                                                                <a href="modal" data-toggle="modal" data-target="#detail-accommodation-bride-service-{{ $orderWedding->id }}"> 
                                                                    <i class="icon-copy  fa fa-eye" data-toggle="tooltip" data-placement="top" title="@lang('messages.Detail')" aria-hidden="true"></i>
                                                                </a>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    @if ($weddingAccommodations)
                                                        @foreach ($weddingAccommodations as $accommodation_invitation)
                                                            <tr class="{{ $accommodation_invitation->public_rate <= 0?"bg-notif":""; }}">
                                                                <td class="pd-2-8">{{ dateFormat($accommodation_invitation->checkin) }} - {{ dateFormat($accommodation_invitation->checkout) }}</td>
                                                                ...
                                                                <td class="pd-2-8 text-right">
                                                                    @if ($orderWedding->handled_by)
                                                                        @if ($orderWedding->handled_by == Auth::user()->id)
                                                                            @if ($orderWedding->status != "Approved")
                                                                                @if ($orderWedding->status != "Paid")
                                                                                    <span>
                                                                                        <a href="modal" data-toggle="modal" data-target="#update-accommodation-invitation-{{ $accommodation_invitation->id }}">
                                                                                            <i class="fa fa-pencil"></i>
                                                                                        </a>
                                                                                    </span>
                                                                                @endif
                                                                    ...
                                                                    @else
                                                                        ...
                                                                        @endif
                                                                    @endif
                                                                    <a href="modal" data-toggle="modal" data-target="#detail-accommodation_invitation-service-{{ $accommodation_invitation->id }}"> 
                                                                        <i class="icon-copy  fa fa-eye" data-toggle="tooltip" data-placement="top" title="@lang('messages.Detail')" aria-hidden="true"></i>
                                                                    </a>
                                                                </td>
                                                            </tr>
                                ...
                                @if ($orderWedding->service == "Wedding Package")
                                                    ...
                                                    @foreach ($addser_ids as $addser_id)
                                                        ...
                                                        <tr>
                                                            @if ($additionalService->venue == "Ceremony Venue")
                                                                <td class="pd-2-8">{{ dateFormat($orderWedding->wedding_date) }}{{ date(' (H:i)',strtotime($orderWedding->slot)) }}</td>
                                                            @elseif($additionalService->venue == "Reception Venue")
                                                                <td class="pd-2-8">{{ dateTimeFormat($orderWedding->reception_date_start) }}</td>
                                                            @else
                                                                <td class="pd-2-8">
                                                                    {{ dateFormat($orderWedding->checkin) }} - {{ dateFormat($orderWedding->checkout) }}
                                                                </td>
                                                            @endif
                                                            ...
                                                            <td class="pd-2-8 text-right">
                                                                <a href="modal" data-toggle="modal" data-target="#detail-additional-service-{{ $additionalService->id }}"> 
                                                                    <i class="icon-copy  fa fa-eye" data-toggle="tooltip" data-placement="top" title="@lang('messages.Detail')" aria-hidden="true"></i>
                                                                </a>
                                                            </td>
                                                        </tr>
                                    ...
                                    <div id="weddingAdditionalCharge" class="col-md-12">
                                        <div class="page-subtitle">
                                            Additional Charge
                                            <span>
                                                <a href="modal" data-toggle="modal" data-target="#add-additional-charge-{{ $orderWedding->id }}">
                                                    <i class="icon-copy  fa fa-plus-circle" data-toggle="tooltip" data-placement="top" title="@lang('messages.Add')" aria-hidden="true"></i>
                                                </a>
                                            </span>
                                        </div>
                                                                    ...
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <select name="date" class="form-control @error('date') is-invalid @enderror" value="{{ old('date') }}" required>
                                                                            ...
                                                                            @for ($dt = 0; $dt < $orderWedding->duration+1; $dt++)
                                                                                <option value="{{ dateFormat('+'.$dt.' days',strtotime($orderWedding->checkin)) }}">{{ dateFormat('+'.$dt.'days',strtotime($orderWedding->checkin)) }}</option>
                                                                            @endfor
                                                                        </select>
                                                                        @error('date')
                                                                            <div class="alert-form">{{ $message }}</div>
                                            ...
                                            <tbody>
                                                @if ($serviceRequests)
                                                    @foreach ($serviceRequests as $no_rexser=>$request_service)
                                                        <tr class="{{ $request_service->price > 0 ?"":"bg-notif"; }} {{ $request_service->status == "Request"?"bg-notif":""; }}">
                                                            <td class="pd-2-8">{{ dateFormat($request_service->date) }}</td>
                                                            ...
                                                            <td class="pd-2-8 text-right">
                                                                @if ($orderWedding->handled_by)
                                                                    @if ($orderWedding->handled_by == Auth::user()->id)
                                                                        <span>
                                                                            <a href="modal" data-toggle="modal" data-target="#update-additional-charge-{{ $request_service->id }}">
                                                                                <i class="fa fa-pencil"></i>
                                                                            </a>
                                                                        </span>
                                                                    @endif
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group ">
                                                                                        ...
                                                                                        <select id="status_{{ $no_rexser }}" name="status" class="form-control @error('status') is-invalid @enderror" value="{{ old('status') }}" required>
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group ">
                                                                                        ...
                                                                                        <select name="date" class="form-control @error('date') is-invalid @enderror" value="{{ old('date') }}" required>
                                                                                            ...
                                                                                            @for ($dt = 0; $dt < $orderWedding->duration+1; $dt++)
                                                                                                <option {{ dateFormat($request_service->date) == dateFormat('+'.$dt.' days',strtotime($orderWedding->checkin))?"selected":""; }} value="{{ dateFormat('+'.$dt.' days',strtotime($orderWedding->checkin)) }}">{{ dateFormat('+'.$dt.' days',strtotime($orderWedding->checkin)) }}</option>
                                                                                            @endfor
                                                                                        </select>
                                                                                        @error('date')
                                                                                            <div class="alert-form">{{ $message }}</div>
                                                ...
                                                @foreach ($serviceRequestRejected as $rejected_service)
                                                    <tr class="{{ $rejected_service->status == "Rejected"?"bg-reject":""; }}" data-toggle="tooltip" title="Status: {{ $rejected_service->status }} | Reason: {{ $rejected_service->remark }}">
                                                        <td class="pd-2-8">{{ dateFormat($rejected_service->date) }}</td>
                                                        ...
                                                        <td class="pd-2-8 text-right">
                                                            @if ($orderWedding->handled_by)
                                                                @if ($orderWedding->handled_by == Auth::user()->id)
                                                                    <span>
                                                                        <a href="modal" data-toggle="modal" data-target="#update-rejected-additional-charge-{{ $rejected_service->id }}">
                                                                            <i class="fa fa-pencil"></i>
                                                                        </a>
                                                                    </span>
                                                                @endif
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                                <div class="form-group ">
                                                                                    ...
                                                                                    <select id="status" name="status" class="form-control @error('status') is-invalid @enderror" value="{{ old('status') }}" required>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-group ">
                                                                                    ...
                                                                                    <select name="date" class="form-control @error('date') is-invalid @enderror" value="{{ old('date') }}" required>
                                                                                        <option value="">@lang('messages.Select date')</option>
                                                                                        @for ($dt = 0; $dt < $orderWedding->duration+1; $dt++)
                                                                                            <option {{ dateFormat($rejected_service->date) == dateFormat('+'.$dt.' days',strtotime($orderWedding->checkin))?"selected":""; }} value="{{ dateFormat('+'.$dt.' days',strtotime($orderWedding->checkin)) }}">{{ dateFormat('+'.$dt.' days',strtotime($orderWedding->checkin)) }}</option>
                                                                                        @endfor
                                                                                    </select>
                                                                                    @error('date')
                                                                                        <div class="alert-form">{{ $message }}</div>
                                        ...
                                        <div class="box-price-kicked">
                                            <div class="row">
                                                <div class="col-8 text-right">
                                                    <div class="promo-text"><b>@lang('messages.Total')</b></div>
                                                </div>
                                                        ...
                                                        <tbody>
                                                            @if ($addser_ids)
                                                                @foreach ($addser_ids as $no_addser=>$addser_id)
                                                                    ...
                                                                    <tr>
                                                                        @if ($additionalService->venue == "Ceremony Venue")
                                                                            <td class="pd-2-8">{{ dateFormat($orderWedding->wedding_date) }}</td>
                                                                        @elseif($additionalService->venue == "Reception Venue")
                                                                            <td class="pd-2-8">{{ dateFormat($orderWedding->reception_date_start) }}</td>
                                                                        @else
                                                                            <td class="pd-2-8">{{ dateFormat($orderWedding->checkin) }}</td>
                                                                        @endif
                                                                        <td class="pd-2-8">{{ $additionalService->service }}</td>
                                                ...
                                                @if ($orderWedding->handled_by)
                                                    @if ($orderWedding->handled_by == $admin->id)
                                                        @if ($orderWedding->status != "Approved")
                                                            @if ($orderWedding->status != "Paid")
                                                                <span>
                                                                    <a href="modal" data-toggle="modal" data-target="#add-additional-service-{{ $orderWedding->id }}"> 
                                                                        @if ($addser_ids)
                                                                            <i class="icon-copy  fa fa-pencil" data-toggle="tooltip" data-placement="top" title="@lang('messages.Change')" aria-hidden="true"></i>
                                                                        @else
                                                                            <i class="icon-copy  fa fa-plus-circle" data-toggle="tooltip" data-placement="top" title="@lang('messages.Add')" aria-hidden="true"></i>
                                    ...
                                    <div id="remarkPage" class="col-md-12">
                                        <div class="page-subtitle">
                                            ...
                                            @if ($orderWedding->remark)
                                                ...
                                                <span>
                                                    <a href="modal" data-toggle="modal" data-target="#add-order-wedding-remark-{{ $orderWedding->id }}">
                                                        <i class="icon-copy  fa fa-pencil" data-toggle="tooltip" data-placement="top" title="@lang('messages.Change')" aria-hidden="true"></i>
                                                    </a>
                                                </span>
                                            @else
                                        ...
                                        <div class="row">
                                            @if ($orderWedding->service == "Wedding Package")
                                                @if ($orderWedding->accommodation_price>0)
                                                    <div class="col-6">
                                                        <div class="promo-text">Accommodation + Extra Bed</div>
                                                    </div>
                                                    <div class="col-6 text-right">
                                                        @if ($accommodationPriceContainZero)
                                                            <div class="promo-text text-red">TBA</div>
                                                        @else
                                                            <div class="promo-text">{{ '$ ' . number_format($orderWedding->accommodation_price + $orderWedding->extra_bed_price, 0, ',', '.') }}</div>
                                                        @endif
                                                    </div>
                                                @endif
                                                @if ($orderWedding->transport_invitations_price>0)
                                                    <div class="col-6">
                                                        <div class="promo-text">Transports</div>
                                                    </div>
                                                    <div class="col-6 text-right">
                                                        @if ($transportPriceContainZero)
                                                            <div class="promo-text text-red">TBA</div>
                                                        @else
                                                            <div class="promo-text">{{ '$ ' . number_format($orderWedding->transport_invitations_price, 0, ',', '.') }}</div>
                                                        @endif
                                                    </div>
                                                @endif
                                                @if (count($serviceRequests)>0)
                                                    <div class="col-6">
                                                        <div class="promo-text">Additional Charge</div>
                                                    </div>
                                                    <div class="col-6 text-right">
                                                        @if ($serviceRequestPriceContainZero)
                                                            <div class="promo-text text-red">TBA</div>
                                                        @else
                                                            <div class="promo-text">{{ '$ ' . number_format($serviceRequestPrice, 0, ',', '.') }}</div>
                                                        @endif
                                                    </div>
                                                @endif
                                                @if ($transportInvitations or $weddingAccommodations)
                                                    ...
                                                    <div class="col-6 text-right">
                                                        <div class="promo-text">{{ '$ ' . number_format($orderWedding->package_price, 0, ',', '.') }}</div>
                                                    </div>
                                                @endif
                                                <div class="col-6">
                                                    <hr class="form-hr">
                                            ...
                                            @else
                                                <div class="col-6">
                                                    @if ($orderWedding->accommodation_price>0)
                                                        <div class="promo-text">@lang('messages.Accommodation') + @lang('messages.Extra Bed')</div>
                                                    @endif
                                                    @if ($orderWedding->ceremony_venue_price > 0)
                                                        <div class="promo-text">@lang('messages.Ceremony Venue')</div>
                                                    @endif
                                                    @if ($orderWedding->ceremony_venue_decoration_price > 0)
                                                        <div class="promo-text">@lang('messages.Ceremony Venue Decoration')</div>
                                                    @endif
                                                    @if ($orderWedding->reception_venue_price > 0)
                                                        <div class="promo-text">@lang('messages.Reception Venue')</div>
                                                    @endif
                                                    @if ($orderWedding->reception_venue_decoration_price > 0)
                                                        <div class="promo-text">@lang('messages.Reception Venue Decoration')</div>
                                                    @endif
                                                    @if ($orderWedding->additional_services_price > 0)
                                                        <div class="promo-text">@lang('messages.Additional Service')</div>
                                                    @endif
                                                    @if ($orderWedding->transport_invitations_price>0)
                                                        <div class="promo-text">@lang('messages.Transportation')</div>
                                                    @endif
                                                    <hr class="form-hr">
                                                    @if ($invoice)
                                                        <div class="price-name">@lang('messages.Total Price') USD</div>
                                                ...
                                                <div class="col-6 text-right">
                                                    ...
                                                    @endif
                                                    @if ($orderWedding->ceremony_venue_price > 0)
                                                        <div class="promo-text">{{ '$ ' .number_format($orderWedding->ceremony_venue_price, 0, ',', '.') }}</div>
                                                    @endif
                                                    @if ($orderWedding->ceremony_venue_decoration_price > 0)
                                                        <div class="promo-text">{{ '$ ' .number_format($orderWedding->ceremony_venue_decoration_price, 0, ',', '.') }}</div>
                                                    @endif
                                                    @if ($orderWedding->reception_venue_price > 0)
                                                        <div class="promo-text">{{ '$ ' .number_format($orderWedding->reception_venue_price, 0, ',', '.') }}</div>
                                                    @endif
                                                    @if ($orderWedding->reception_venue_decoration_price > 0)
                                                        <div class="promo-text">{{ '$ ' .number_format($orderWedding->reception_venue_decoration_price, 0, ',', '.') }}</div>
                                                    @endif
                                                    @if ($orderWedding->additional_services_price > 0)
                                                        <div class="promo-text">{{ '$ ' .number_format($orderWedding->additional_services_price, 0, ',', '.') }}</div>
                                                    @endif
                                                    @if ($orderWedding->transport_invitations_price>0)
                                                        @if ($transportPriceContainZero)
                                                            <div class="promo-text text-red">TBA</div>
                                    ...
                                    @if ($orderWedding->status == 'Approved')
                                        @if ($orderWedding->handled_by)
                                            @if ($orderWedding->handled_by == Auth::user()->id)
                                                ...
                                                <a href="modal" data-toggle="modal" data-target="#upload-invoice-pdf-{{ $orderWedding->id }}"> 
                                ...
                                <div class="col-md-12">
                                    <div class="card-box">
                                        <div class="card-box-title">
                                            ...
                                            @if ($invoice->balance > 0)
                                                <span>
                                                    <a href="modal" data-toggle="modal" data-target="#desktop-admin-add-receipt-wedding-{{ $orderWedding->id }}">
                                                        <i class="icon-copy fa fa-plus" aria-hidden="true"></i>
                                                    </a>
                                                </span>
                                            @endif
