...
<div id="weddingOrders" class="card-box m-b-18">
    ...
    <div class="input-container">
        <div class="input-group">
            ...
            <input id="searchWeddingOrdersByAgn" type="text" onkeyup="searchTable('searchWeddingOrdersByAgn','tbWeddings',1)" class="form-control" name="search-waiting-order-byagn" placeholder="Search by agent...">
        </div>
        <div class="input-group">
            <span class="input-group-addon"><i class="icon-copy fa fa-search" aria-hidden="true"></i></span>
            <input id="searchWeddingOrderByBride" type="text" onkeyup="searchTable('searchWeddingOrderByBride','tbWeddings',2)" class="form-control" name="search-waiting-order-type" placeholder="Search by brides...">
        </div>
    </div>
                    ...
                    @foreach ($validOrderWeddings as $order_wedding)
                        ...
                        @endphp
                            @if ($order_wedding->status == "Pending" or $order_wedding->status == "Process" or $order_wedding->status == "Approved" or $order_wedding->status == "Paid")
                                ...
                                <tr>
                                    <td>
                                        <b>{{ dateFormat($order_wedding->created_at) }}</b>
