    ...
    @can('isAdmin')
                                        ...
                                        <div class="page-card">
                                            ...
                                            <div class="card-content">
                                                <div class="card-text">
                                                    <div class="row ">
                                                        <div class="col-4">
                                                            <div class="card-title"><i class="icon-copy fa fa-building" aria-hidden="true"></i>Hotel:</div>
                                                        ...
                                                        <div class="col-4">
                                                            ...
                                                            <div class="data-web">{{  dateFormat($weddings->period_start)." - ".dateFormat($weddings->period_end) }} </div>
                                                        </div>
                                                       
                                                        <div class="col-12 m-t-8">
                                                            <div class="card-title"><i class="icon-copy fa fa-file-pdf-o" aria-hidden="true"></i> PDF Rate:</div>
                                                            <a href="modal" data-target="#wedding-pdf-{{ $weddings->id }}" data-toggle="modal">
        ...
        <script>
            ...
            function scrollFunction() {
              if (document.body.scrollTop > 0 || document.documentElement.scrollTop > 160) {
                document.getElementById("btnAction").style.visibility = "visible";
                document.getElementById("btnActionOn").style.visibility = "hidden";
              } else {
                document.getElementById("btnAction").style.visibility = "hidden";
                document.getElementById("btnActionOn").style.visibility = "visible";
              }
            }
        </script>
    @endcan
