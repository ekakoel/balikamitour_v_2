                                ...
                                <div class="card-box">
                                    ...
                                    @canany(['posDev','posAuthor'])
                                        <div class="card-box-footer">
                                            <a href="modal" data-toggle="modal" data-target="#edit-partner"><button class="btn btn-primary"><i class="fa fa-pencil"></i> Edit Partner</button></a>
                                        </div>
                                        {{-- MODAL EDIT PARTNER --------------------------------------------------------------------------------------------------------------- --}}
                                    ...
                                    <div class="col-md-12">
                                        <div class="card-box">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6 text-right">
                                                    <p><b>{{ dateFormat($partner->created_at) }}</b></p>
                                                    <p><i>{{ Carbon::parse($partner->created_at)->diffForHumans();  }}</i></p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    @if (count($activitys) > 0)
                                        <div class="card-box-content">
                                            @foreach ($activitys as $activity)
                                                <div class="card">
                                                    <div class="image-container">
                                                        <a href="modal" data-toggle="modal" data-target="#detail-activity-{{ $activity->id }}">
                                    ...
                                    @if (count($tours) > 0)
                                        <div class="card-box-content">
                                            @foreach ($tours as $tour)
                                                <div class="card">
                                                    <div class="image-container">
                                                        <a href="modal" data-toggle="modal" data-target="#detail-tour-{{ $tour->id }}">
                                                            <div class="card-status">
