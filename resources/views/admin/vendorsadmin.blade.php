                            ...
                            <div class="card-box">
                                ...
                                @canany(['posDev','weddingDvl','weddingAuthor'])
                                    <div class="card-box-footer">
                                        <a href="modal" data-toggle="modal" data-target="#add-vendor"><button class="btn btn-primary"><i class="ion-plus-round"></i> Add Vendor</button></a>
                                    </div>
                                    {{-- MODAL ADD VENDOR --------------------------------------------------------------------------------------------------------------- --}}
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea name="term" id="term" wire:model="term" class="ckeditor form-control @error('term') is-invalid @enderror" placeholder="Terms and Conditions" type="text">{!! old('term') !!}</textarea>
                                                                        @error('term')
                                                                            <span class="invalid-feedback">
                                                                                <strong>{{ $message }}</strong>
                                                                            </span>
