                ...
                <div class="min-height-200px">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="card-box">
                                <div class="card-box-title">
                                    <div class="subtitle"><i class="fa fa-building" aria-hidden="true"></i> {{ $hotel->name }}</div>
                                </div>
                                <div class="page-card">
                                                ...
                                                <div class="row">
                                                    @if (isset($hotel->check_out_time))
                                                        <div class="col-6">
                                                            ...
                                                            <p><i class="fa fa-clock-o" aria-hidden="true"></i> {{ dateTimeFormat($hotel->check_out_time) }}</p>
                                                        </div>
                                                    @endif
                                                    @if (isset($hotel->check_in_time))
                                                        <div class="col-6">
                                                            <div class="card-subtitle">Check-in</div>
                                                            <p><i class="fa fa-clock-o" aria-hidden="true"></i> {{ dateTimeFormat($hotel->check_in_time) }}</p>
                                                        </div>
                                                    @endif
                                                </div>
                                            @endif
                            ...
                            <div class="card-box">
                                        ...
                                        @foreach ($wedding_contracts->where('hotels_id',$hotel->id) as $contract)
                                            <div class="card-contract p-8">
                                                ...
                                                <div class="card-action text-right">
                                                    <a class="action-btn" href="modal" data-toggle="modal" data-target="#contract-wedding-{{ $contract->id }}">
                                                        <i class="icon-copy fa fa-eye" aria-hidden="true"></i>
                                                    </a>
                                                    @canany(['posDev','posAuthor'])
                                                        <a class="action-btn" href="modal" data-toggle="modal" data-target="#edit-wedding-contract-{{ $contract->id }}">
                                                            <i class="icon-copy fa fa-pencil" aria-hidden="true"></i>
                                                        </a>
                                                        <a class="action-btn" href="modal" data-toggle="modal" data-target="#delete-wedding-contract-{{ $contract->id }}">
                                ...
                                @canany(['posDev','posAuthor'])
                                    <div class="card-box-footer">
                                        <a href="modal" data-toggle="modal" data-target="#add-wedding-contract-{{ $hotel->id }}" data-toggle="tooltip" data-placement="top" title="Add more contract">
                            ...
                            <div id="EntranceFee" class="card-box">
                                ...
                                @canany(['posDev','posAuthor'])
                                    <div class="card-box-footer">
                                        <a href="modal" data-toggle="modal" data-target="#update-entrance-fee-{{ $hotel->id }}">
                            ...
                            <div id="cancellationPolicy" class="card-box">
                                ...
                                @canany(['posDev','posAuthor'])
                                    <div class="card-box-footer">
                                        <a href="modal" data-toggle="modal" data-target="#update-cancellation-policy-{{ $hotel->id }}">
                            ...
                            <div id="weddingInformation" class="card-box">
                                ...
                                @canany(['posDev','posAuthor'])
                                    <div class="card-box-footer">
                                        <a href="modal" data-toggle="modal" data-target="#update-other-information-{{ $hotel->id }}">
