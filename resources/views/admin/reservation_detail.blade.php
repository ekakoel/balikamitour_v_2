                    ...
                    <div class="col-lg-8">
                        <div class="product-wrap card-box mb-30 d-print">
                            <div class="product-detail-wrap">
                                        ...
                                        <table class="table tb-list">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="htd-2">{{ dateFormat($reservation->checkin)." - ".dateFormat($reservation->checkout) }}</td>
                                                </tr>
                                                <tr>
                                            ...
                                            @if ($reservation->status == "Pending")
                                                <span>
                                                    @if ($reservation->arrival_flight != "" or $reservation->arrival_time != "" or $reservation->departure_flight != "" or $reservation->departure_time != "")
                                                        <a href="modal" data-toggle="modal" data-target="#update-flight-{{ $reservation->id }}"> 
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="page-subtitle d-print-none">Guide
                                                @if ($reservation->status != "Active" and $guide == "")
                                                    <span>
                                                        <a href="modal" data-toggle="modal" data-target="#add-guide-{{ $reservation->id }}"> 
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="reservation-guest">
                                                                ...
                                                                @if ($reservation->status != "Active")
                                                                    <span>
                                                                        <a href="modal" data-toggle="modal" data-target="#edit-guide-{{ $reservation->id }}"> 
                                        ...
                                        <div class="col-md-6">
                                            <div class="page-subtitle d-print-none">Driver
                                                @if ($driver == "")
                                                    <span>
                                                        <a href="modal" data-toggle="modal" data-target="#add-driver-{{ $reservation->id }}"> 
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="reservation-guest">
                                                                ...
                                                                @if ($reservation->status != "Active")
                                                                    <span>
                                                                        <a href="modal" data-toggle="modal" data-target="#edit-driver-{{ $reservation->id }}"> 
                                                    ...
                                                    <tbody>
                                                        @foreach ($order_accomodation as $no_acc=>$order)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    {{ " (".$order->orderno.") ".dateFormat($order->checkin)." - ".dateFormat($order->checkout).", ".$order->servicename.", ".$order->subservice." (".$order->number_of_room." unit)" }}
                                                                ...
                                                                @if ($reservation->status != "Active")
                                                                    <td class="text-center">
                                                                        <div class="table-action">
                                                                            <a href="modal" data-toggle="modal" data-target="#detail-order-{{ $order->id }}"> 
                                                        ...
                                                        @foreach ($activitytours as $no_act=>$activitytour)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <p>{{ dateFormat($activitytour->checkin)." - ".dateFormat($activitytour->checkout) }}</p>
                                                                    @else
                                                                    <p>{{ dateFormat($activitytour->checkin)." - ".dateFormat($activitytour->checkin) }}</p>
                                                                    @endif
                                                                </td>
                                                                <td>
                                                                ...
                                                                @if ($reservation->status != "Active")
                                                                    <td>
                                                                        <div class="reservation-guest">
                                                                            <span>
                                                                                <a href="modal" data-toggle="modal" data-target="#detail-activitytour-{{ $activitytour->id }}"> 
                                                                                    <button class="btn-view"><i class="icon-copy fa fa-eye" aria-hidden="true"></i></button>
                                                                                </a>
                                                ...
                                                <table class="data-table table table-bordered">
                                                    ...
                                                    <tbody>
                                                        @foreach ($transports as $transport)
                                                            <tr>
                                                                <td>
                                                                    <p>{{ dateFormat($transport->checkin) }}</p>
                                                                </td>
                                                                <td>
                                                                ...
                                                                @if ($reservation->status != "Active")
                                                                    <td>
                                                                        <div class="reservation-guest">
                                                                            <span>
                                                                                <a href="modal" data-toggle="modal" data-target="#detail-transport-{{ $transport->id }}"> 
                                                                                    <button class="btn-view"><i class="icon-copy fa fa-eye" aria-hidden="true"></i></button>
                                                                                </a>
                                ...
                                {{-- Itinerary ===================================================================================================================== --}}
                                @php
                                    $from = dateFormat($reservation->checkin);
                                    $dur = $dur_res + 1;
                                    $date_stay = [];
                                    for ($a=0; $a < $dur ; $a++) { 
                                        $date_stay[$a] = $from;
                                        $from = dateFormat('+1 days',strtotime($from));
                                    }
                                @endphp
                                <div id="itinerarys" class="page-subtitle d-print-none">Itinerary
                                    @if ($reservation->status != "Active")
                                        <span>
                                            <a href="modal" data-toggle="modal" data-target="#add-itinerary-{{ $reservation->id }}"> 
                                                                ...
                                                                @if ($reservation->status != "Active")
                                                                    <td class="text-right">
                                                                        <div class="table-action">
                                                                            ...
                                                                            <a href="modal" data-toggle="modal" data-target="#edit-itinerary-{{ $itinerary->id }}"> 
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="col-sm-4">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <select name="date" class="form-control @error('date') is-invalid @enderror" placeholder="Select date" required>
                                                                                                    <option selected value="{{ dateFormat($itinerary->date) }}">{{ dateFormat($itinerary->date) }}</option>
                                                                                                    @foreach ($date_stay as $datestay)
                                                                                                        <option value="{{ dateFormat($datestay) }}">{{ dateFormat($datestay) }}</option>
                                                                                                    @endforeach
                                                                                                </select>
                                                                                            </div>
                                                                                        </div>
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="date" class="form-control @error('date') is-invalid @enderror" placeholder="Select date" required>
                                                                        ...
                                                                        @foreach ($date_stay as $datestay)
                                                                            <option value="{{ dateFormat($datestay) }}">{{ dateFormat($datestay) }}</ption>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            </div>
                                ...
                                <div class="page-subtitle d-print-none">Restaurant
                                    @if ($reservation->status != "Active")
                                        <span>
                                            <a href="modal" data-toggle="modal" data-target="#add-restaurant-{{ $reservation->id }}"> 
                                                        ...
                                                        <tr>
                                                            ...
                                                            @if ($reservation->status != "Active")
                                                                <td>
                                                                    <div class="reservation-guest">
                                                                        <span>
                                                                            <a href="modal" data-toggle="modal" data-target="#edit-restaurant-{{ $restaurant->id }}"> 
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="col-sm-3">
                                                                                            <div class="form-group">
                                                                                                <label for="date">Date <span>*</span></label>
                                                                                                <select name="date" class="form-control @error('date') is-invalid @enderror" placeholder="Select date" required>
                                                                                                    <option selected value="{{ $restaurant->date }}">{{ dateFormat($restaurant->date) }}</option>
                                                                                                    @foreach ($date_stay as $datestay)
                                                                                                        <option value="{{ dateFormat($datestay) }}">{{ dateFormat($datestay) }}</ption>
                                                                                                    @endforeach
                                                                                                </select>
                                ...
                                <div class="page-subtitle d-print-none">Include
                                    @if ($reservation->status != "Active")
                                        <span>
                                            <a href="modal" data-toggle="modal" data-target="#add-include-{{ $reservation->id }}"> 
                                                    ...
                                                    <tr>
                                                        ...
                                                        @if ($reservation->status != "Active")
                                                            <td>
                                                                <div class="reservation-guest">
                                                                    <span>
                                                                        <a href="modal" data-toggle="modal" data-target="#edit-include-{{ $include->id }}"> 
                                                                            <button class="btn-view"><i class="icon-copy fa fa-pencil" aria-hidden="true"></i></button>
                                                                        </a>
                                ...
                                <div class="page-subtitle d-print-none">Exclude
                                    @if ($reservation->status != "Active")
                                        <span>
                                            <a href="modal" data-toggle="modal" data-target="#add-exclude-{{ $reservation->id }}"> 
                                                    ...
                                                    <tr>
                                                        ...
                                                        @if ($reservation->status != "Active")
                                                            <td>
                                                                <div class="reservation-guest">
                                                                    <span>
                                                                        <a href="modal" data-toggle="modal" data-target="#edit-exclude-{{ $exclude->id }}"> 
                                                                            <button class="btn-view"><i class="icon-copy fa fa-pencil" aria-hidden="true"></i></button>
                                                                        </a>
                                ...
                                <div class="page-subtitle d-print-none">Remark
                                    @if ($reservation->status != "Active")
                                        <span>
                                            <a href="modal" data-toggle="modal" data-target="#add-remark-{{ $reservation->id }}"> 
                                                    ...
                                                    <tr>
                                                        ...
                                                        @if ($reservation->status != "Active")
                                                            <td>
                                                                <div class="reservation-guest">
                                                                    <span>
                                                                        <a href="modal" data-toggle="modal" data-target="#edit-remark-{{ $remark->id }}"> 
                                                                            <button class="btn-view"><i class="icon-copy fa fa-pencil" aria-hidden="true"></i></button>
                                                                        </a>
                                ...
                                <div style="display: flex; justify-content: flex-end;" class="col-md-12 text-right p-b-18">
                                    ...
                                    @else
                                        <form action="/fadd-invoice" method="post" enctype="multipart/form-data">
                                            ...
                                            <input type="hidden" name="inv_date" value="{{ dateFormat($now) }}">
                                            <input type="hidden" name="due_date" value="{{ dateFormat('+2 weeks',strtotime($now)) }}">
