<div class="row">
    <div class="col-6 col-sm-6">
        <div class="form-group">
            ...
            <select wire:model="selectedHotel" name="hotel_id" class="form-control @error('hotel_id') is-invalid @enderror" required>
    ...
    <div class="col-6 col-sm-6">
        <div class="form-group">
            ...
            <select wire:model="selectedVenue" name="wedding_venue_id" class="form-control @error('wedding_venue_id') is-invalid @enderror" required>
