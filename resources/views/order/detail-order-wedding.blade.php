                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 text-right">
                                <div class="label-date float-right" style="width: 100%">
                                    {{ dateFormat($orderWedding->created_at) }}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="pd-2-8 text-right">
                                                    <a href="modal" data-toggle="modal" data-target="#detail-invitation-{{ $invitation->id }}">
                                                        <span>
                                                    ...
                                                    <div class="card-text">
                                                        <div class="row ">
                                                            <div class="col-sm-12 text-center">
                                                                ...
                                                                @if ($orderWedding->service == "Ceremony Venue")
                                                                    <p>{{ dateFormat($orderWedding->wedding_date) }} ({{ date('H.i',strtotime($orderWedding->slot)) }})</p>
                                                                @elseif ($orderWedding->service == "Reception Venue")
                                                                    <p>{{ dateFormat($orderWedding->reception_date_start) }} ({{ date('H.i',strtotime($orderWedding->slot)) }})</p>
                                                                @elseif ($orderWedding->service == "Wedding Package")
                                                                    <p>
                                                                        @lang('messages.Wedding Date'): 
                                                                        {{ dateFormat($orderWedding->wedding_date) }} ({{ date('H.i',strtotime($orderWedding->slot)) }}) | 
                                                                        @lang('messages.Reception Date'):
                                                                        {{ dateFormat($orderWedding->reception_date_start) }}
                                                                    </p>
                                                                @endif
                                                                {!! $hotel->address !!}
                                                            </div>
                            ...
                            @if ($receptionVenue)
                                <div id="orderWeddingDecorationReceptionVenue" class="col-md-6">
                                    ...
                                    @endphp
                                    <a href="modal" data-toggle="modal" data-target="#detail-decoration-reception-venue-{{ $orderWedding->id }}"> 
                                        <div class="page-subtitle">
                                            @lang('messages.Decoration')
                            ...
                            @if ($lunchVenue)
                                <div id="weddingLunchVenue" class="col-md-6">
                                    <a href="modal" data-toggle="modal" data-target="#detail-lunch-venue-{{ $lunchVenue->id }}"> 
                                        <div class="page-subtitle">
                            ...
                            @if ($dinnerVenue)
                                <div id="weddingLunchVenue" class="col-md-6">
                                    <a href="modal" data-toggle="modal" data-target="#detail-dinner-venue-{{ $dinnerVenue->id }}"> 
                                        <div class="page-subtitle">
                                        ...
                                        <tbody>
                                            ...
                                            @if ($wedding_accommodations)
                                                @foreach ($wedding_accommodations as $inv_suite_villa)
                                                    <tr>
                                                        <td class="pd-2-8">
                                                            {{ dateFormat($inv_suite_villa->checkin) }} -
                                                            {{ dateFormat($inv_suite_villa->checkout) }}
                                                        </td>
                                                        <td class="pd-2-8">
                                                            {{ $hotel->name }}
                                                        </td>
                                        ...
                                        <tbody>
                                            @if ($bride_transports_id)
                                                ...
                                                @endphp
                                                    ...
                                                    @endphp
                                                    <tr>
                                                        <td class="pd-2-8">{{ dateFormat($orderWedding->checkin) }} (<i>@lang('messages.Include')</i>)</td>
                                                    ...
                                                    <tr>
                                                        <td class="pd-2-8">{{ dateFormat($orderWedding->checkout) }} (<i>@lang('messages.Include')</i>)</td>
                                            ...
                                            @foreach ($transports_orders as $transport_inv)
                                                <tr>
                                                    <td class="pd-2-8">{{ dateTimeFormat($transport_inv->date) }}</td>
                                                ...
                                                <tbody>
                                                    @foreach ($addser_ids as $addser_id)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="pd-2-8 text-right">
                                                                <a href="modal" data-toggle="modal" data-target="#detail-additional-service-{{ $service_include->id }}"> 
                                                                    <i class="icon-copy  fa fa-eye" data-toggle="tooltip" data-placement="top" title="@lang('messages.Detail')" aria-hidden="true"></i>
                                                                </a>
                                                            </td>
                                                        </tr>
                                        ...
                                        <table class="data-table table stripe hover nowrap no-footer dtr-inline" >
                                            ...
                                            <tbody>
                                                @foreach ($additional_charges as $service_request)
                                                    <tr>
                                                        <td class="pd-2-8">{{ dateTimeFormat($service_request->date) }}</td>
                                                ...
                                                <tbody>
                                                    @if ($addser_ids)
                                                        @foreach ($addser_ids as $no_addser=>$addser_id)
                                                            ...
                                                            @endphp
                                                            <tr>
                                                                <td class="pd-2-8">{{ $additionalService->venue == "Ceremony Venue"? dateFormat($orderWedding->wedding_date):dateFormat($orderWedding->reception_date_start) }}</td>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            @if ($orderWedding->service == "Wedding Package")
                                                ...
                                                @if (count($transports_orders)>0)
                                                    @if ($transportContainsNullPrice)
                                                        <div class="promo-text">@lang('messages.Transports')</div>
                                                    @else
                                                        <div class="promo-text">@lang('messages.Transports')</div>
                                                    @endif
                                                @endif
                                            ...
                                            @else
                                                ...
                                                @endif
                                                @if ($accommodationPrice > 0)
                                                    <div class="promo-text">@lang('messages.Accommodation')</div>
                                                @endif
                                                @if (count($transports_orders)>0)
                                                    @if ($transportContainsNullPrice)
                                                        <div class="promo-text">@lang('messages.Transports')</div>
                                        ...
                                        <div class="col-6 text-right">
                                            @if ($orderWedding->service == "Wedding Package")
                                                @if ($accommodationPrice > 0)
                                                    ...
                                                    @else
                                                        <div class="promo-text">{{ '$ ' .number_format($accommodationPrice, 0, ',', '.') }}</div>
                                                    @endif
                                                @endif
                                                @if (count($transports_orders)>0)
                                                    @if ($transportContainsNullPrice)
                                                        <div class="promo-price text-blue" data-toggle="tooltip" data-placement="left" title="@lang('messages.To be advised')">TBA</div>
                                                    @else
                                                        <div class="promo-text">{{ '$ ' .number_format($transportPrice, 0, ',', '.') }}</div>
                                                    @endif
                                                @endif
                                                @if (count($additional_charges)>0)
                                                    @if ($additionalChargeContainZero)
                                                        <div class="promo-text text-blue" data-toggle="tooltip" data-placement="left" title="@lang('messages.To be advised')">TBA</div>
                                                    @else
                                                        <div class="promo-text">{{ '$ ' .number_format($additional_charge_price, 0, ',', '.') }}</div>
                                                    @endif
                                                @endif
                                                <div class="promo-text">{{ '$ ' .number_format($orderWedding->package_price, 0, ',', '.') }}</div>
                                            @else
                                                @if ($ceremonyVenuePrice > 0)
                                                    <div class="promo-text">{{ '$ ' .number_format($ceremonyVenuePrice, 0, ',', '.') }}</div>
                                                @endif
                                                @if ($ceremonyVenueDecorationPrice > 0)
                                                    <div class="promo-text">{{ '$ ' .number_format($ceremonyVenueDecorationPrice, 0, ',', '.') }}</div>
                                                @endif
                                                @if ($receptionVenuePrice > 0)
                                                    <div class="promo-text">{{ '$ ' .number_format($receptionVenuePrice, 0, ',', '.') }}</div>
                                                @endif
                                                @if ($receptionVenueDecorationPrice > 0)
                                                    <div class="promo-text">{{ '$ ' .number_format($receptionVenueDecorationPrice, 0, ',', '.') }}</div>
                                                @endif
                                                @if ($accommodationPrice > 0)
                                                    @if ($accommodation_containt_zero)
                                                ...
                                                @endif
                                                @if ($additionalServicePrice > 0)
                                                    <div class="promo-text">{{ '$ ' .number_format($additionalServicePrice, 0, ',', '.') }}</div>
                                                @endif
                                            @endif
                                            <hr class="form-hr">
                        ...
                        <div class="card-box-footer">
                            @if ($invoice)
                                @if ($invoice->balance>=1)
                                    <a href="modal" data-toggle="modal" data-target="#weddingPaymentConfirmation-{{ $orderWedding->id }}">
                            ...
                            @if ($invoice)
                                @if (config('app.locale') == "zh")
                                    ...
                                    {{-- <a href="modal" data-toggle="modal" data-target="#contract-zh-{{ $orderWedding->id }}">
                                ...
                                @else
                                    ...
                                    @endif
                                    <a href="modal" data-toggle="modal" data-target="#invoice-{{ $orderWedding->orderno }}">
                                        ...
                                        @foreach ($receipts as $receipt)
                                            @if ($receipt->status == "Valid")
                                                <div class="pmt-container">
                                                    ...
                                                    <div class="btn-action-right">
                                                        <a href="modal" data-toggle="modal" data-target="#desktop-valid-receipt-{{ $receipt->id }}">
                                            ...
                                            @elseif($receipt->status == "Pending")
                                                <div class="pmt-container pending">
                                                    ...
                                                    <div class="btn-action-right">
                                                        <a href="modal" data-toggle="modal" data-target="#desktop-paid-receipt-{{ $receipt->id }}">
                                                            <i class="icon-copy fa fa-eye" aria-hidden="true"></i>
                                                        </a>
                                                    </div>
                                                </div>
                                            ...
                                            @elseif($receipt->status == "Invalid")
                                                <div class="pmt-container unpaid">
                                                    ...
                                                    <div class="btn-action-right">
                                                        <a href="modal" data-toggle="modal" data-target="#desktop-invalid-receipt-{{ $receipt->id }}">
                                                            <i class="icon-copy fa fa-eye" aria-hidden="true"></i>
                                                        </a>
                                                    </div>
                                                </div>
                                    ...
                                    {{-- @if (isset($receipts))
                                        @if ($receipts->status == "Paid")
                                            ...
                                            <div class="view-receipt">
                                                <a class="action-btn" href="modal" data-toggle="modal" data-target="#receipt-{{ $receipts->id }}">
                                                    <i class="icon-copy fa fa-eye" aria-hidden="true"></i>
                                                </a>
                                            </div>
