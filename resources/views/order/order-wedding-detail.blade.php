                            ...
                            <div class="box-price-kicked">
                                <div class="row">
                                    ...
                                    <div class="col-6 col-md-6 text-right">
                                        <div class="subtotal-price">{{ "$ ".number_format(($total_wedding_services), 0, ".", ",") }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-12">
                <div class="box-price-kicked">
                    <div class="row">
                        ...
                        <div class="col-6 col-md-6 text-right">
                            @if ($total_additional_service > 0)
                                <div class="promo-text">{{ "$ ".number_format($wedding_order->fixed_service_price + $wedding->markup, 0, ".", ",") }}</div>
                                <div class="promo-text">{{ "$ ".number_format($total_wedding_services, 0, ".", ",") }}</div>
            ...
            <div class="row">
                @if ($receipt)
                    @foreach ($receipt as $rcpt)
                            ...
                            <div class="col-md-8">
                                <div class="pmt-des">
                                    @if ($rcpt->status == "Valid")
                                        ...
                                        {!! $rcpt->note !!}
                                        Amount : {{ "$ ".number_format($rcpt->amount, 0, ".", ",") }}
                            ...
                            <div class="col-md-2">
                                <div class="view-receipt">
                                    <a class="action-btn" href="modal" data-toggle="modal" data-target="#receipt-{{ $rcpt->id }}">
                                        <i class="icon-copy fa fa-eye" aria-hidden="true"></i>
                                    </a>
                                    @if ($rcpt->status == "Invalid")
                                        <a href="modal" data-toggle="modal" data-target="#update-receipt-{{ $rcpt->id }}">
                    ...
                    <div class="col-6 text-right">
                        <p>{{ "$ ".number_format($total_payment, 0, ".", ",") }}</p>
                    </div>
                    <div class="col-6">
                        <p>Total Invoice :</p>
                    </div>
                    <div class="col-6 text-right">
                        <p>{{ "$ ".number_format($order->final_price, 0, ".", ",") }}</p>
                    </div>
                    <div class="col-12">
                        <hr class="form-hr">
                    </div>
                    @if ($balance_payment < 0)
                        ...
                        <div class="col-6 text-right">
                            <b>{{ "$ ".number_format($balance_payment*-1, 0, ".", ",") }}</b>
                        </div>
                    @else
                        <div class="col-6">
                            <b>Balance Payment :</b>
                        ...
                        <div class="col-6 text-right">
                            <b style="color:rgb(153, 0, 0);">{{ "- $ ".number_format($balance_payment, 0, ".", ",") }}</b>
                        </div>
                    @endif
                @else
                <div class="col-md-12">
