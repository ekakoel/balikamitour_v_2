                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-box">
                            ...
                            <table class="data-table table nowrap" >
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 20%;">@lang('messages.Src') <=> @lang('messages.Dst') </th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <div class="table-action">
                                                    ...
                                                    <a href="modal" data-toggle="modal" data-target="#edit-airport-shuttle-{{ $airport_shuttle->id }}">
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="col-sm-2">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="text" name="date" class="form-control datetimepicker @error('date') is-invalid @enderror" value="{{ dateFormat($airport_shuttle->date) }}" required>
                                                                                                @error('date')
                                                                                        ...
                                                                                        <div class="col-sm-2">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <select type="text" name="src" class="form-control @error('src') is-invalid @enderror" required>
                                                                                        ...
                                                                                        <div class="col-sm-2">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <select type="text" name="dst" class="form-control @error('dst') is-invalid @enderror" required>
                            ...
                            <div class="card-box-footer">
                                <a href="modal" data-toggle="modal" data-target="#add-airport-shuttle">
                                                                    ...
                                                                    <div class="control-group">
                                                                        <div class="row">
                                                                            <div class="col-sm-2">
                                                                                <div class="form-group">
                                                                                    <label for="date">Date</label>
                                                                                    <input type="text" name="date" class="form-control datetimepicker @error('date') is-invalid @enderror" value="{{ old('date') }}" required>
                                                                                    @error('date')
                                                                                        <div class="alert alert-danger">
                                                                                            {{ $message }}
                                                                                        </div>
