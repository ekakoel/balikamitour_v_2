                                    ...
                                    <div class="box-price-kicked">
                                        <div class="row">
                                            @if (count($wedding_accommodations)>0)
                                                <div class="col-6">
                                                    <div class="promo-text">@lang('messages.Accommodations') + @lang('messages.Extra Bed')</div>
                                                </div>
                                                <div class="col-6 text-right">
                                                    ...
                                                    @else
                                                        <div class="promo-text">{{ '$ ' .number_format($wedding_accommodation_price+$extra_bed_orders_price, 0, ',', '.') }}</div>
                                                    @endif
                                                </div>
                                            @endif
                                            @if (count($transport_orders)>0)
                                                ...
                                                <div class="col-6 text-right">
                                                    @if ($transportContainsNullPrice)
                                                        <div class="promo-price" data-toggle="tooltip" data-placement="left" title="@lang('messages.To be advised')">TBA</div>
                                                    @else
                                                        <div class="promo-text">{{ '$ ' .number_format($transport_orders_prices, 0, ',', '.') }}</div>
                                                    @endif
                                                </div>
                                            @endif
                                            @if (count($additionalServices)>0)
                                                <div class="col-6">
                                                    <div class="promo-text">@lang('messages.Additional Charge') / @lang('messages.Services') (@lang('messages.Request'))</div>
                                                </div>
                                                <div class="col-6 text-right">
                                                    @if ($additionalServicesPricesTba)
                                                        <div class="promo-price" data-toggle="tooltip" data-placement="left" title="@lang('messages.To be advised')">TBA</div>
                                                    @else
                                                        <div class="promo-text">{{ '$ ' .number_format($additionalServicesPrices, 0, ',', '.') }}</div>
                                                    @endif
                                                </div>
                                            @endif
                                    ...
                                    <div class="box-price-kicked">
                                        <div class="row">
                                            ...
                                            <div class="col-6 text-right">
                                                ...
                                                @endif
                                                @if ($orderWedding->accommodation_price > 0)
                                                    <div class="promo-text">{{ '$ ' .number_format($orderWedding->accommodation_price, 0, ',', '.') }}</div>
                                                @endif
                                                @if ($orderWedding->transport_invitations_price>0)
                                                ...
                                                @endif
                                                @if ($orderWedding->addser_price > 0)
                                                <div class="promo-text">{{ '$ ' .number_format($orderWedding->addser_price, 0, ',', '.') }}</div>
                                                @endif
                                                <hr class="form-hr">
