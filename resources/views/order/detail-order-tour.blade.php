...
<div class="col-md-8">
    <div class="card-box">
        ...
        <div class="row">
                    ...
                    <div class="col-md-12">
                        <table class="table tb-list">
                            ...
                            <tr>
                                ...
                                <td class="htd-2">
                                    @php
                                        $cguests = count($guests);
                                    @endphp
                                    @if ($cguests > 0)
                                        @if ($cguests > 1)
                                            @foreach ($guests as $guest)
                                                {!! $guest->name." (".$guest->sex.")" !!}
                                            @endforeach
                                        @else
                                            @foreach ($guests as $guest)
                                                {!! $guest->name." (".$guest->sex.")" !!}
            ...
            <div class="col-md-6">
                <div class="page-subtitle">@lang('messages.Shuttle')</div>
                <div class="row">
                    <div class="col-md-12">
                        <table class="table tb-list">
                            <tr>
                                <td class="htd-1">
                                    @lang('messages.Pick up location')
                                </td>
                                <td class="htd-2">
                            ...
                            <tr>
                                <td class="htd-1">
                                    @lang('messages.Drop off location')
                                </td>
                                <td class="htd-2">
            ...
            @if (isset($guide->id))
                <div class="col-md-6">
                    <div class="page-subtitle">@lang('messages.Guide')</div>
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table tb-list">
                                <tr>
            ...
            @if (isset($driver->id))
                <div class="col-md-6">
                    <div class="page-subtitle">@lang('messages.Driver')</div>
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table tb-list">
                                <tr>
                    ...
                    <div class="row">
                        <div class="col-6 col-md-6">
                            @if ($total_additional_service > 0)
                                <div class="promo-text">@lang('messages.'.$order->service)</div>
