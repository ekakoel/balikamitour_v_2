<div class="col-md-8">
    @php
        $checkin = dateFormat($order->checkin);
        $wedding_date = dateFormat($order->wedding_date);
        $checkout = dateFormat($order->checkout);
    @endphp
    <div class="card-box">
        ...
        <form id="edit-order" action="/fupdate-order/{{ $order->id }}" method="post" enctype="multipart/form-data">
                            ...
                            @if ($wedding->fixed_services_id)
                                ...
                                @if ($vendor_wedding_fixed_services)
                                    @foreach ($fixed_services_id as $fixed_service_id)
                                        ...
                                        @if ($f_service)
                                            <div class="card">
                                                <a href="modal" data-toggle="modal" data-target="#detail-wedding-fixed-service-{{ $f_service->id }}">
                                    ...
                                    @if ($vendor_service->id == $w_v_id)
                                        @foreach ($order_wedding_venues_id as $o_w_v_id)
                                            @if ($w_v_id == $o_w_v_id)
                                                <div class="card">
                                                    <div class="image-container">
                                                        <a href="modal" data-toggle="modal" data-target="#wedding-venue-{{ $vendor_service->id }}">
                                        ...
                                        @foreach ($o_w_suites_and_villas_ids as $o_w_suites_and_villas_id)
                                            @if ($w_suites_and_villas_id == $o_w_suites_and_villas_id)
                                                <div class="card active">
                                                    <div class="image-container">
                                                        <a href="modal" data-toggle="modal" data-target="#wedding-suites-and-villas-{{ $vendor_suites_and_villa->id }}">
                            ...
                            @foreach ($vendor_services as $vendor_service)
                                @foreach ($order_wedding_dinner_venues_ids as $order_wedding_dinner_venues_id)
                                    @if ($vendor_service->id == $order_wedding_dinner_venues_id)
                                        <div class="card">
                                            <div class="image-container">
                                                <a href="modal" data-toggle="modal" data-target="#wedding-dinner-venue-{{ $vendor_service->id }}">
                                                    <img class="img-fluid rounded thumbnail-image" src="{{ asset('storage/vendors/package/' . $vendor_service->cover) }}" alt="{{ $vendor_service->service }}">
                                                </a>
                                            </div>
                                            <div class="name-card">
                            ...
                            @foreach ($vendor_services as $vendor_service)
                                @foreach ($order_wedding_decorations_id as $o_w_decoration_id)
                                    @if ($vendor_service->id == $o_w_decoration_id)
                                        <div class="card">
                                            <div class="image-container">
                                                <a href="modal" data-toggle="modal" data-target="#wedding-decoration-{{ $vendor_service->id }}">
                                                    <img class="img-fluid rounded thumbnail-image" src="{{ asset('storage/vendors/package/' . $vendor_service->cover) }}" alt="{{ $vendor_service->service }}">
                                                </a>
                                            </div>
                                            <div class="name-card">
                            ...
                            @foreach ($vendor_services as $vendor_service)
                                @foreach ($order_wedding_makeups_id as $o_w_makeup_id)
                                    @if ($vendor_service->id == $o_w_makeup_id)
                                        <div class="card">
                                            <div class="image-container">
                                                <a href="modal" data-toggle="modal" data-target="#wedding-makeup-{{ $vendor_service->id }}">
                                                    <img class="img-fluid rounded thumbnail-image" src="{{ asset('storage/vendors/package/' . $vendor_service->cover) }}" alt="{{ $vendor_service->service }}">
                                                </a>
                                            </div>
                                            <div class="name-card">
                            ...
                            @foreach ($vendor_services as $vendor_service)
                                @foreach ($order_wedding_entertainments_id as $o_w_entertainment_id)
                                    @if ($vendor_service->id == $o_w_entertainment_id)
                                        <div class="card">
                                            <div class="image-container">
                                                <a href="modal" data-toggle="modal" data-target="#wedding-entetainment-{{ $vendor_service->id }}">
                                                    <img class="img-fluid rounded thumbnail-image" src="{{ asset('storage/vendors/package/' . $vendor_service->cover) }}" alt="{{ $vendor_service->service }}">
                                                </a>
                                            </div>
                                            <div class="name-card">
                            ...
                            @foreach ($vendor_services as $vendor_service)
                                @foreach ($order_wedding_documentation_ids as $order_wedding_documentation_id)
                                    @if ($vendor_service->id == $order_wedding_documentation_id)
                                        <div class="card">
                                            <div class="image-container">
                                                <a href="modal" data-toggle="modal" data-target="#wedding-documentation-{{ $vendor_service->id }}">
                                                    <img class="img-fluid rounded thumbnail-image" src="{{ asset('storage/vendors/package/' . $vendor_service->cover) }}" alt="{{ $vendor_service->service }}">
                                                </a>
                                            </div>
                                            <div class="name-card">
                            ...
                            @foreach ($vendor_wedding_transports as $vendor_wedding_transport)
                                @foreach ($order_wedding_transport_ids as $order_wedding_transport_id)
                                    @if ($vendor_wedding_transport->id == $order_wedding_transport_id)
                                        <div class="card">
                                            <div class="image-container">
                                                <a href="modal" data-toggle="modal" data-target="#wedding-transport-{{ $vendor_wedding_transport->id }}">
                            ...
                            @foreach ($vendor_services as $vendor_service)
                                @foreach ($order_wedding_other_ids as $order_wedding_other_id)
                                    @if ($vendor_service->id == $order_wedding_other_id)
                                        <div class="card">
                                            <div class="image-container">
                                                <a href="modal" data-toggle="modal" data-target="#wedding-other-{{ $vendor_service->id }}">
                                                    <img class="img-fluid rounded thumbnail-image" src="{{ asset('storage/vendors/package/' . $vendor_service->cover) }}" alt="{{ $vendor_service->service }}">
                                                </a>
                                            </div>
                                            <div class="name-card">
            ...
            <div class="form-group row m-b-18">
                ...
                <div class="col-md-4">
                    ...
                    <input readonly type="text" name="checkin" placeholder="@lang('messages.Select date')" class="form-control date-picker @error('checkin') is-invalid @enderror" value="{{ dateFormat($order->checkin) }}" required>
                    @error('checkin')
                        <div class="alert alert-danger">
                            {{ $message }}
                        </div>
                ...
                <div class="col-md-4">
                    ...
                    <input readonly type="text" name="wedding_date" placeholder="@lang('messages.Select date')" class="form-control date-picker @error('wedding_date') is-invalid @enderror" value="{{ dateFormat($order_wedding->wedding_date) }}" required>
                    @error('wedding_date')
                        <div class="alert alert-danger">
                            {{ $message }}
                        </div>
            ...
            <div class="form-group row m-b-18">
                ...
                <div class="col-md-6">
                    ...
                    <input readonly type="text" name="departure_time" class="form-control datetimepicker @error('departure_time') is-invalid @enderror" placeholder="@lang('messages.Select date and time')" value="{{ dateTimeFormat($order->departure_time) }}">
