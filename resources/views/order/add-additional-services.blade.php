                            ...
                            <div class="col-md-12">
                                <table class="table tb-list">
                                    ...
                                    <tr>
                                        ...
                                        <td class="htd-2">{{ dateTimeFormat($order->created_at) }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    @if ($order->service == "Wedding Package")
                                        ...
                                        <tr>
                                            ...
                                            <td class="htd-2">{{ dateTimeFormat($order->wedding_date) }}</td>
                                        </tr>
                                    @endif
                                    <tr>
                                        <td class="htd-1">Check In</td>
                                        <td class="htd-2">{{ dateFormat($order->checkin) }}</td>
                                    </tr>
                                    <tr>
                                        <td class="htd-1">Check Out</td>
                                        <td class="htd-2">{{ dateFormat($order->checkout) }}</td>
                                    </tr>
                                    <tr>
