                                    ...
                                    @if ($day_ones)
                                        ...
                                        @foreach ($day_ones as $day_one)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="modal" data-toggle="modal" data-target="#detail-itinerary-{{ $day_one->id }}">
                                    ...
                                    @if ($day_twos)
                                        ...
                                        @foreach ($day_twos as $day_two)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="modal" data-toggle="modal" data-target="#detail-itinerary-{{ $day_two->id }}">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                </td>
                                            </tr>
                                    ...
                                    @if ($day_thres)
                                        ...
                                        @foreach ($day_thres as $day_thre)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="modal" data-toggle="modal" data-target="#detail-itinerary-{{ $day_thre->id }}">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                </td>
                                            </tr>
