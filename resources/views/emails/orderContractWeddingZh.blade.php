            ...
            <div class="heading">
                <table class="table">
                    ...
                    <tr class="tb-heading" style="width: 100%">
                        ...
                        <td>
                            <div class="order-date" style="text-align: right">{{ dateFormat($order_wedding->updated_at) }}</div>
                        </td>
                    </tr>
                </table>
            </div>
                    ...
                    <tr>
                        <td>
                            <div class="heading-left">
                                ...
                                <div class="business-sub p-b-8">{{ $business->caption }}</div>
                            </div>
                        </td>
                    </tr>
                </table>
                    ...
                    <table class="table-order">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="table-service-name">
                                        {{ dateFormat($order_wedding->checkin) }} ({{ date('h.i a',strtotime($order_wedding->slot)) }}) - 
                                        {{ dateFormat($order_wedding->checkout) }} ({{ date('h.i a',strtotime($order_wedding->checkout)) }}) 
                                    </div>
                                </td>
                            ...
                            @foreach ($wedding_accommodations as $inv_room)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-service-name">
                                            {{ dateFormat($order_wedding->checkin) }} ({{ date('h.i a',strtotime($order_wedding->hotel->checkin)) }}) - 
                                            {{ dateFormat($order_wedding->checkout) }} ({{ date('h.i a',strtotime($order_wedding->hotel->checkout)) }}) 
                                        </div>
                                    </td>
                        ...
                        @if ($order_wedding->service != "Wedding Package")
                            ...
                            @if ($order_wedding->ceremony_venue_id)
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-service-name">
                                            {{ dateFormat($order_wedding->wedding_date) }} ({{ date('h.i a',strtotime($order_wedding->slot)) }})
                                        </div>
                                    </td>
                                            ...
                                            <td>
                                                <div class="table-service-name">
                                                    ...
                                                    @elseif($additionalService->venue == "Reception Venue")
                                                        {{ dateFormat($order_wedding->reception_date_start) }} ({{ date('h.i a',strtotime($order_wedding->reception_date_start)) }})
                                                    @else
                                                        {{ dateFormat($order_wedding->checkin) }} - {{ dateFormat($order_wedding->checkout) }}
                                                    @endif
                        ...
                        @if ($invoice->currency->name == "USD")
                            @foreach ($transactions_usd as $transaction)
                                <tr>
                                    <td colspan="3" class="text-right"><p>{{ dateFormat($transaction->transaction_date) }} {{ $transaction->type == "Debit"?"RECEIVED":""; }} {{ $transaction->kurs_name }} {{ '$ ' . number_format($transaction->amount, 0, ',', '.') }}</p></td>
                                    <td class="text-right">
                        ...
                        @elseif ($invoice->currency->name == "IDR")
                            @foreach ($transactions_idr as $transaction)
                                <tr>
                                    <td colspan="3" class="text-right"><p>{{ dateFormat($transaction->transaction_date) }} {{ $transaction->type == "Debit"?"RECEIVED":""; }} {{ $transaction->kurs_name }} {{ 'Rp ' . number_format($transaction->amount, 0, ',', '.') }}</p></td>
                                    <td class="text-right">
