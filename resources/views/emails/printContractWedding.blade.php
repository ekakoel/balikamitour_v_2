            ...
            <div class="card-box" style="page-break-after: always;">
                ...
                <table class="table-order">
                    ...
                    @for ($iti = 0; $iti <= $w_duration; $iti++)
                        ...
                        @if (count($wis) >0)
                            <tr>
                                <td colspan="3"><b>Day {{ $w_day.'-'.dateFormat($order->checkin) }}</b></td>
                            </tr>
                                    ...
                                    @if ($order->status == "pending")
                                        <td>
                                            <div class="table-action">
                                                <a href="modal" data-toggle="modal" data-target="#detail-itinerary-{{ $wedding_itinerary->id }}">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="table-service-name">
                                        {{ dateFormat($order_wedding->wedding_date) }}
                                    </div>
                                </td>
                                    ...
                                    <div class="table-service-name">
                                        @foreach ($order_suite_and_villa_ids as $order_suite_and_villa_id)
                                            ...
                                            @if (count($order_suite_and_villa_ids)>1)
                                                {{ "- ".$wedding_hotel->name.", ".dateFormat($order->checkin)."th - ".dateFormat($order->checkout).'th, '.$order->duration." nights, ".$wedding_site_and_villa->rooms }}<br>
                                            @else
                                                {{ $wedding_hotel->name.", ".dateFormat($order->checkin)."th - ".dateFormat($order->checkout).'th, '.$order->duration." nights, ".$wedding_site_and_villa->rooms }}
                                            @endif
                                        @endforeach
                                    </div>
                                </td>
                            ...
                            @if ($order->additional_service != "null")
                                ...
                                @for ($v = 0; $v < $cad; $v++)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="table-service-name">
                                                {{ dateFormat($adser_date[$v)) }}
                                            </div>
                                        </td>
                                        <td>
                                            <div class="table-service-name">
                                                {{ dateFormat($adser_date[$v]).", ".$adser[$v] }}
                                            </div>
                                        </td>
